...
(schema.spec.variant.VariantSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k24174,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k24174,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__24180){
var vec__24181 = p__24180;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24181,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24181,(1),null);
...
var G__24184 = schema.utils.value_name(x);
return (self__.err_f.cljs$core$IFn$_invoke$arity$1 ? self__.err_f.cljs$core$IFn$_invoke$arity$1(G__24184) : self__.err_f.call(null,G__24184));
}),null)),null));
...
var or__5045__auto____$1 = (function (){var G__24187 = (cljs.core.truth_(new cljs.core.Keyword(null,"return-walked?","return-walked?",-1684646015).cljs$core$IFn$_invoke$arity$1(params))?v:x);
return (self__.post.cljs$core$IFn$_invoke$arity$1 ? self__.post.cljs$core$IFn$_invoke$arity$1(G__24187) : self__.post.call(null,G__24187));
})();
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this24175,other24176){
var self__ = this;
var this24175__$1 = this;
return (((!((other24176 == null)))) && ((((this24175__$1.constructor === other24176.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24175__$1.pre,other24176.pre)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24175__$1.options,other24176.options)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24175__$1.err_f,other24176.err_f)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24175__$1.post,other24176.post)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24175__$1.__extmap,other24176.__extmap)))))))))))));
}));
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k24174){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k24174);

}
}));

(schema.spec.variant.VariantSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__24173){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__24205 = cljs.core.keyword_identical_QMARK_;
var expr__24206 = k__5352__auto__;
if(cljs.core.truth_((pred__24205.cljs$core$IFn$_invoke$arity$2 ? pred__24205.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__24206) : pred__24205.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__24206)))){
return (new schema.spec.variant.VariantSpec(G__24173,self__.options,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__24205.cljs$core$IFn$_invoke$arity$2 ? pred__24205.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"options","options",99638489),expr__24206) : pred__24205.call(null,new cljs.core.Keyword(null,"options","options",99638489),expr__24206)))){
return (new schema.spec.variant.VariantSpec(self__.pre,G__24173,self__.err_f,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__24205.cljs$core$IFn$_invoke$arity$2 ? pred__24205.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__24206) : pred__24205.call(null,new cljs.core.Keyword(null,"err-f","err-f",651620941),expr__24206)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,G__24173,self__.post,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__24205.cljs$core$IFn$_invoke$arity$2 ? pred__24205.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"post","post",269697687),expr__24206) : pred__24205.call(null,new cljs.core.Keyword(null,"post","post",269697687),expr__24206)))){
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,G__24173,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__24173),null));
}
}
}
}
...
(schema.spec.variant.VariantSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__24173){
var self__ = this;
var this__5342__auto____$1 = this;
return (new schema.spec.variant.VariantSpec(self__.pre,self__.options,self__.err_f,self__.post,G__24173,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.variant.map__GT_VariantSpec = (function schema$spec$variant$map__GT_VariantSpec(G__24177){
var extmap__5385__auto__ = (function (){var G__24210 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__24177,new cljs.core.Keyword(null,"pre","pre",2118456869),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.Keyword(null,"err-f","err-f",651620941),new cljs.core.Keyword(null,"post","post",269697687)], 0));
if(cljs.core.record_QMARK_(G__24177)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__24210);
} else {
return G__24210;
}
})();
return (new schema.spec.variant.VariantSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__24177),new cljs.core.Keyword(null,"options","options",99638489).cljs$core$IFn$_invoke$arity$1(G__24177),new cljs.core.Keyword(null,"err-f","err-f",651620941).cljs$core$IFn$_invoke$arity$1(G__24177),new cljs.core.Keyword(null,"post","post",269697687).cljs$core$IFn$_invoke$arity$1(G__24177),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
