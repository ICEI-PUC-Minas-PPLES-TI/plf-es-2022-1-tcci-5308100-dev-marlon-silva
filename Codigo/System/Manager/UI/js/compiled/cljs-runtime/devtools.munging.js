...
var o8838 = temp__5802__auto__;
var temp__5802__auto____$1 = (o8838["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o8839 = temp__5802__auto____$1;
return (o8839["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8440__auto__ = f;
return (o__8440__auto__["toString"]).call(o__8440__auto__);
} else {
return "";
}
}catch (e8845){var _ = e8845;
return "";
}});
...
try{var o__8440__auto___9117 = t;
(o__8440__auto___9117["cljs$lang$ctorPrWriter"]).call(o__8440__auto___9117,t,writer);
}catch (e8851){var __9119 = e8851;
}
...
var char_code = (function (){var o__8440__auto__ = (new String(char$));
return (o__8440__auto__["charCodeAt"]).call(o__8440__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8440__auto__ = String;
return (o__8440__auto__["fromCharCode"]).call(o__8440__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__8861 = num_code;
switch (G__8861) {
case (1):
return (185);
...
var o__8440__auto__ = String;
return (o__8440__auto__["fromCharCode"]).call(o__8440__auto__,superscript_code);
});
/**
...
}catch (e8893){var _e__8471__auto__ = e8893;
return false;
}})())){
...
var vec__8900 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8900,(0),null);
...
var len__5769__auto___9124 = arguments.length;
var i__5770__auto___9125 = (0);
while(true){
if((i__5770__auto___9125 < len__5769__auto___9124)){
args__5775__auto__.push((arguments[i__5770__auto___9125]));

var G__9126 = (i__5770__auto___9125 + (1));
i__5770__auto___9125 = G__9126;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__8926){
var vec__8927 = p__8926;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8927,(0),null);
...
var G__9130 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__9131 = cljs.core.butlast(remaining_tokens);
name_tokens = G__9130;
remaining_tokens = G__9131;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq8924){
var G__8925 = cljs.core.first(seq8924);
var seq8924__$1 = cljs.core.next(seq8924);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__8925,seq8924__$1);
}));
...
var vec__8932 = cljs.core.split_with((function (p1__8931_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__8931_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8932,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8932,(1),null);
...
var vec__8939 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8939,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8939,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__9135 = cljs.core.rest(remaining_tokens);
var G__9136 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__9135;
name_tokens = G__9136;
continue;
} else {
...
var vec__8945 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8945,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8945,(1),null);
var vec__8948 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8948,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8948,(1),null);
var vec__8951 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8951,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8951,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8951,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8951,(3),null);
...
var vec__8980 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8980,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8980,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8980,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8980,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8980,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8980,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__8985 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8985,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8985,(1),null);
var vec__8988 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8988,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8988,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__8995 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__8995) : devtools.munging.parse_fn_info_deep.call(null,G__8995));
})()));
}
} else {
return fn_info;
...
var G__9196 = (arity + (1));
var G__9197 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9005){
var vec__9006 = p__9005;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9006,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9006,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9013_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__9013_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9014_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__9014_SHARP_);
}),sorted_infos);
...
var args__5775__auto__ = [];
var len__5769__auto___9212 = arguments.length;
var i__5770__auto___9214 = (0);
while(true){
if((i__5770__auto___9214 < len__5769__auto___9212)){
args__5775__auto__.push((arguments[i__5770__auto___9214]));

var G__9219 = (i__5770__auto___9214 + (1));
i__5770__auto___9214 = G__9219;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9017){
var vec__9018 = p__9017;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9018,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9015){
var G__9016 = cljs.core.first(seq9015);
var seq9015__$1 = cljs.core.next(seq9015);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9016,seq9015__$1);
}));
...
var G__9021 = arg;
var G__9021__$1 = (((G__9021 instanceof cljs.core.Keyword))?G__9021.fqn:null);
switch (G__9021__$1) {
...
var map__9025 = options;
var map__9025__$1 = cljs.core.__destructure_map(map__9025);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9025__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9025__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9025__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9025__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9026 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9026,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9026,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9026,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9026,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9026,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9026,(5),null);
...
var o__8440__auto__ = f;
return (o__8440__auto__["getBasis"]).call(o__8440__auto__);
});
/**
...
}catch (e9048){var _e__8471__auto__ = e9048;
...
var G__9303 = (obj[cljs.core.first(path)]);
var G__9304 = cljs.core.rest(path);
obj = G__9303;
path = G__9304;
continue;
} else {
...
var _STAR_ = (function (accum,p__9061){
var vec__9062 = p__9061;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9062,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9062,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9068){
var vec__9069 = p__9068;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9069,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9069,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9069,(2),null);
...
var post_process = (function (p__9084){
var vec__9085 = p__9084;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9085,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9085,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9079_SHARP_){
return (obj[cljs.core.first(p1__9079_SHARP_)]);
}),sorted_matches);
