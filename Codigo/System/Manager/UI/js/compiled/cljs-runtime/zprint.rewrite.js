...
var G__24036 = rewrite_clj.zip.next(n);
loc = G__24036;
continue;
} else {
var G__24037 = rewrite_clj.zip.next(loc);
loc = G__24037;
continue;
}
} else {
var G__24038 = rewrite_clj.zip.next(loc);
loc = G__24038;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__24020 = zloc;
var G__24020__$1 = (((G__24020 == null))?null:rewrite_clj.zip.node(G__24020));
if((G__24020__$1 == null)){
return null;
} else {
return rewrite_clj.zip.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__24020__$1);
}
})())));
});
/**
...
var G__24043 = rewrite_clj.zip.down(nloc);
nloc = G__24043;
continue;
}
break;
...
var G__24045 = rewrite_clj.zip.right(nloc);
var G__24046 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__24045;
out = G__24046;
continue;
} else {
...
var G__24049 = rewrite_clj.zip.right(replaced_loc);
var G__24050 = cljs.core.next(new_loc);
var G__24051 = replaced_loc;
nloc = G__24049;
new_loc = G__24050;
last_loc = G__24051;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__24025_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__24025_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__24025_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
