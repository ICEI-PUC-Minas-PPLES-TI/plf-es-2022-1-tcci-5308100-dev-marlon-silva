...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14439 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14439(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14440 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14440(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14441 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14441(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14442 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14442(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14446 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14446(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14447 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14447(reader);
}
});
...
var G__14470 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14471 = s.append(c);
c = G__14470;
s = G__14471;
continue;
}
