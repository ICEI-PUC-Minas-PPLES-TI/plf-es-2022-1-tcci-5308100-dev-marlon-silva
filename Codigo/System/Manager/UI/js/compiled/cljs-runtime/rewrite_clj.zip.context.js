...
return rewrite_clj.zip.walk.postwalk.cljs$core$IFn$_invoke$arity$3(zloc,(function (p1__21308_SHARP_){
var G__21309 = rewrite_clj.custom_zipper.core.node(p1__21308_SHARP_);
if((!((G__21309 == null)))){
if(((false) || ((cljs.core.PROTOCOL_SENTINEL === G__21309.rewrite_clj$node$protocols$MapQualifiable$)))){
return true;
} else {
if((!G__21309.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_(rewrite_clj.node.protocols.MapQualifiable,G__21309);
} else {
return false;
}
}
