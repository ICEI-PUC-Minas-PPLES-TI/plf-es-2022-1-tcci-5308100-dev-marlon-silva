...
var G__15949 = o;
reagent.impl.template.goog$module$goog$object.set(G__15949,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__15976__delegate = function (args){
...
while (G__15977__i < G__15977__a.length) {G__15977__a[G__15977__i] = arguments[G__15977__i + 0]; ++G__15977__i;}
  args = new cljs.core.IndexedSeq(G__15977__a,0,null);
} 
return G__15976__delegate.call(this,args);};
G__15976.cljs$lang$maxFixedArity = 0;
G__15976.cljs$lang$applyTo = (function (arglist__15978){
var args = cljs.core.seq(arglist__15978);
return G__15976__delegate(args);
});
...
var G__15950 = o;
reagent.impl.template.goog$module$goog$object.set(G__15950,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__15951 = props;
var G__15951__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15951,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15951);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15951__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__15952 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__15952,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__15952;
}
})(),id_class);
...
var G__15953 = (cljs.core.count(argv) - first_child);
switch (G__15953) {
case (0):
...
var vec__15954 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15954,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15954,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15954,(2),null);
...
var temp__5808__auto___15998 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___15998 == null)){
} else {
var key_15999 = temp__5808__auto___15998;
(jsprops.key = key_15999);
}
...
var temp__5808__auto___16001 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___16001 == null)){
} else {
var key_16002 = temp__5808__auto___16001;
(jsprops.key = key_16002);
}
...
var temp__5808__auto___16007 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___16007 == null)){
} else {
var key_16008 = temp__5808__auto___16007;
(jsprops.key = key_16008);
}
...
var temp__5808__auto___16015 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___16015 == null)){
} else {
var key_16016 = temp__5808__auto___16015;
(jsprops.key = key_16016);
}
...
var temp__5808__auto___16017 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___16017 == null)){
} else {
var key_16018 = temp__5808__auto___16017;
(jsprops.key = key_16018);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__15957_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__15957_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__15958 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15958,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15958,(1),null);
...
break;
default:
var G__16020 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__16021 = compiler;
v = G__16020;
compiler = G__16021;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template15964 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template15964 = (function (opts,id,fn_to_element,parse_fn,meta15965){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template15964.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_15966,meta15965__$1){
var self__ = this;
var _15966__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template15964(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta15965__$1));
}));

(reagent.impl.template.t_reagent$impl$template15964.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_15966){
var self__ = this;
var _15966__$1 = this;
return self__.meta15965;
}));

(reagent.impl.template.t_reagent$impl$template15964.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template15964.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template15964.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template15964.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template15964.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template15964.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta15965","meta15965",142596459,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template15964.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template15964.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template15964");

(reagent.impl.template.t_reagent$impl$template15964.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template15964");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template15964.
 */
reagent.impl.template.__GT_t_reagent$impl$template15964 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template15964(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta15965){
return (new reagent.impl.template.t_reagent$impl$template15964(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta15965));
});

}

return (new reagent.impl.template.t_reagent$impl$template15964(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
