...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15894 = c;
var G__15894__$1 = (((G__15894 == null))?null:G__15894.prototype);
if((G__15894__$1 == null)){
return null;
} else {
return G__15894__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15895 = c;
var G__15895__$1 = (((G__15895 == null))?null:G__15895.prototype);
if((G__15895__$1 == null)){
return null;
} else {
return G__15895__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__15908 = c;
var G__15908__$1 = (((G__15908 == null))?null:G__15908.constructor);
if((G__15908__$1 == null)){
return null;
} else {
return G__15908__$1.displayName;
}
})();
...
var G__15909 = c;
var G__15909__$1 = (((G__15909 == null))?null:G__15909.constructor);
if((G__15909__$1 == null)){
return null;
} else {
return G__15909__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__15910 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15911 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15911);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15910);
}});
reagent.impl.component.rat_opts = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"no-cache","no-cache",1588056370),true], null);
reagent.impl.component.custom_wrapper = (function reagent$impl$component$custom_wrapper(key,f){
var G__15912 = key;
var G__15912__$1 = (((G__15912 instanceof cljs.core.Keyword))?G__15912.fqn:null);
switch (G__15912__$1) {
...
var c = this;
var G__15914_15938 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__15914_15938 == null)){
} else {
reagent.ratom.dispose_BANG_(G__15914_15938);
}
...
var renders_15939 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_15940 = cljs.core.first(cljs.core.vals(renders_15939));
...
if((cljs.core.count(renders_15939) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_15939))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_15940)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_15940], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__15917 = o;
reagent.impl.component.goog$module$goog$object.set(G__15917,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__15922 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__15923 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__15923);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__15922);
}});
...
var vec__15924 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15924,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15924,(1),null);
...
var G__15927 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__15927 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__15927);
}
});
}),[]);
