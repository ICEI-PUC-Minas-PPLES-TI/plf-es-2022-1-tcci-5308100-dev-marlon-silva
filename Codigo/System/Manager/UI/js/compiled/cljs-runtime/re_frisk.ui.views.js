...
});})(i__47429,vec__47431,idx,name,diff,item,c__5521__auto__,size__5522__auto__,b__47430,s__47428__$2,temp__5804__auto__,items))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47430),re_frisk$ui$views$history_item_$_iter__47427(cljs.core.chunk_rest(s__47428__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47430),null);
}
} else {
var vec__47434 = cljs.core.first(s__47428__$2);
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47434,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47434,(1),null);
var diff = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47434,(2),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47434,(3),null);
return cljs.core.cons((cljs.core.truth_(diff)?cljs.core.with_meta(new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"align","align",1964212802),new cljs.core.Keyword(null,"center","center",-748944368),new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"border-bottom","border-bottom",2110948415),"1px solid #ebebeb"], null),new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),new cljs.core.Keyword(null,"pointer","pointer",85071187),new cljs.core.Keyword(null,"width","width",-384071477),"200px",new cljs.core.Keyword(null,"margin-top","margin-top",392161226),"5px",new cljs.core.Keyword(null,"text-overflow","text-overflow",-1022366814),new cljs.core.Keyword(null,"ellipsis","ellipsis",998505738),new cljs.core.Keyword(null,"white-space","white-space",-707351930),new cljs.core.Keyword(null,"nowrap","nowrap",457264988),new cljs.core.Keyword(null,"overflow","overflow",2058931880),new cljs.core.Keyword(null,"hidden","hidden",-312506092),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"purple","purple",-876021126)], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__47434,idx,name,diff,item,s__47428__$2,temp__5804__auto__,items){
return (function (event){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(tool_state,cljs.core.assoc,new cljs.core.Keyword(null,"selected-event","selected-event",898030638),item);
...
return event.preventDefault();
});})(vec__47434,idx,name,diff,item,s__47428__$2,temp__5804__auto__,items))
], null),name], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.gap,new cljs.core.Keyword(null,"size","size",1098693007),"10px"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.frisk.Root_Simple,diff], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),idx], null)):null),re_frisk$ui$views$history_item_$_iter__47427(cljs.core.rest(s__47428__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.components.scroller,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"#f3f3f3"], null)], null),(function (){var iter__5523__auto__ = (function re_frisk$ui$views$app_db_view_$_iter__47448(s__47449){
return (new cljs.core.LazySeq(null,(function (){
var s__47449__$1 = s__47449;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__47449__$1);
if(temp__5804__auto__){
var s__47449__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47449__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__47449__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__47451 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__47450 = (0);
while(true){
if((i__47450 < size__5522__auto__)){
var watcher = cljs.core._nth(c__5521__auto__,i__47450);
cljs.core.chunk_append(b__47451,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.views.watch_item,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(app_db_derefed,watcher),watcher,watchers], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),watcher], null)));

var G__47569 = (i__47450 + (1));
i__47450 = G__47569;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47451),re_frisk$ui$views$app_db_view_$_iter__47448(cljs.core.chunk_rest(s__47449__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47451),null);
}
} else {
var watcher = cljs.core.first(s__47449__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.views.watch_item,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(app_db_derefed,watcher),watcher,watchers], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),watcher], null)),re_frisk$ui$views$app_db_view_$_iter__47448(cljs.core.rest(s__47449__$2)));
}
} else {
return null;
}
...
var map__47479 = cljs.core.deref(tool_state);
var map__47479__$1 = cljs.core.__destructure_map(map__47479);
var timeline_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47479__$1,new cljs.core.Keyword(null,"timeline-opened?","timeline-opened?",1560712236));
var paused_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47479__$1,new cljs.core.Keyword(null,"paused?","paused?",-135058553));
var graph_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47479__$1,new cljs.core.Keyword(null,"graph-opened?","graph-opened?",153449318));
var stat_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47479__$1,new cljs.core.Keyword(null,"stat-opened?","stat-opened?",1063397443));
var views_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47479__$1,new cljs.core.Keyword(null,"views-opened?","views-opened?",-1040443216));
var events_opened_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47479__$1,new cljs.core.Keyword(null,"events-opened?","events-opened?",-1069565502));
...
var len__5769__auto___47582 = arguments.length;
var i__5770__auto___47583 = (0);
while(true){
if((i__5770__auto___47583 < len__5769__auto___47582)){
args__5775__auto__.push((arguments[i__5770__auto___47583]));

var G__47584 = (i__5770__auto___47583 + (1));
i__5770__auto___47583 = G__47584;
continue;
} else {
}
break;
...
(re_frisk.ui.views.main_view.cljs$core$IFn$_invoke$arity$variadic = (function (re_frame_data,tool_state,p__47494){
var vec__47496 = p__47494;
var doc = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47496,(0),null);
...
/** @this {Function} */
(re_frisk.ui.views.main_view.cljs$lang$applyTo = (function (seq47488){
