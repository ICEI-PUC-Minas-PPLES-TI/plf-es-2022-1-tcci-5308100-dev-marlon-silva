...
var hierarchy__5646__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__19814 = cljs.core.get_global_hierarchy;
return (fexpr__19814.cljs$core$IFn$_invoke$arity$0 ? fexpr__19814.cljs$core$IFn$_invoke$arity$0() : fexpr__19814.call(null));
})());
...
return rewrite_clj.reader.read_repeatedly(reader,(function (p1__19815_SHARP_){
var _STAR_delimiter_STAR__orig_val__19816 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__19817 = delimiter;
(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__19817);

try{return rewrite_clj.parser.core.parse_next(p1__19815_SHARP_);
}finally {(rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__19816);
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__5775__auto__ = [];
var len__5769__auto___19839 = arguments.length;
var i__5770__auto___19840 = (0);
while(true){
if((i__5770__auto___19840 < len__5769__auto___19839)){
args__5775__auto__.push((arguments[i__5770__auto___19840]));

var G__19841 = (i__5770__auto___19840 + (1));
i__5770__auto___19840 = G__19841;
continue;
} else {
}
break;
...
(rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__19822){
var vec__19823 = p__19822;
var ignore_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19823,(0),null);
...
/** @this {Function} */
(rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq19818){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19819,G__19820,G__19821,seq19818__$3);
}));
...
var G__19834 = rewrite_clj.reader.peek(reader);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__19834)){
return rewrite_clj.reader.throw_reader(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("!",G__19834)){
...
return cljs.core.cons((function (){var G__19836 = rewrite_clj.reader.peek(reader);
switch (G__19836) {
case "(":
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__19834)){
