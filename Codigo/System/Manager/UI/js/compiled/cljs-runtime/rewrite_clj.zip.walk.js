...
var G__21291 = rewrite_clj.zip.move.next(rewrite_clj.zip.walk.process_loc(loc,p_QMARK_,f));
loc = G__21291;
continue;
}
break;
...
var G__21293 = rewrite_clj.zip.walk.downmost(rewrite_clj.zip.move.right(loc__$1));
loc = G__21293;
continue;
} else {
if(cljs.core.truth_(rewrite_clj.zip.move.up(loc__$1))){
var G__21294 = rewrite_clj.zip.move.up(loc__$1);
loc = G__21294;
continue;
} else {
return loc__$1;
...
return rewrite_clj.zip.subedit.subedit_node(zloc,(function (p1__21287_SHARP_){
return rewrite_clj.zip.walk.postwalk_subtree(p_QMARK_,f,p1__21287_SHARP_);
}));
}));
