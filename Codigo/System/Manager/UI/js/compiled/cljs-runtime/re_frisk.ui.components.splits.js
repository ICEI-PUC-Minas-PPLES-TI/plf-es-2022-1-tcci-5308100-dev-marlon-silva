...
var G__45969 = current_node.parentNode;
var G__45970 = (sum_scroll_left + current_node.scrollLeft);
var G__45971 = (sum_scroll_top + current_node.scrollTop);
current_node = G__45969;
sum_scroll_left = G__45970;
sum_scroll_top = G__45971;
continue;
} else {
...
var vec__45831 = (cljs.core.truth_(size_only)?split_size_only:null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45831,(0),null);
var num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45831,(1),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45831,(2),null);
...
var len__5769__auto___45983 = arguments.length;
var i__5770__auto___45984 = (0);
while(true){
if((i__5770__auto___45984 < len__5769__auto___45983)){
args__5775__auto__.push((arguments[i__5770__auto___45984]));

var G__45986 = (i__5770__auto___45984 + (1));
i__5770__auto___45984 = G__45986;
continue;
} else {
}
break;
...
(re_frisk.ui.components.splits.h_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__45851){
var map__45852 = p__45851;
var map__45852__$1 = cljs.core.__destructure_map(map__45852);
var args = map__45852__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45852__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45852__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45852__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45852__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45852__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45852__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45852__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
var document__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45852__$1,new cljs.core.Keyword(null,"document","document",-1329188687),document);
...
var G__45853_45987 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__45853_45987) : on_split_change.call(null,G__45853_45987));
} else {
}
...
return (function() { 
var G__45990__delegate = function (p__45926){
var map__45928 = p__45926;
var map__45928__$1 = cljs.core.__destructure_map(map__45928);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45928__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
while (G__45993__i < G__45993__a.length) {G__45993__a[G__45993__i] = arguments[G__45993__i + 0]; ++G__45993__i;}
  p__45926 = new cljs.core.IndexedSeq(G__45993__a,0,null);
} 
return G__45990__delegate.call(this,p__45926);};
G__45990.cljs$lang$maxFixedArity = 0;
G__45990.cljs$lang$applyTo = (function (arglist__45994){
var p__45926 = cljs.core.seq(arglist__45994);
return G__45990__delegate(p__45926);
});
...
/** @this {Function} */
(re_frisk.ui.components.splits.h_split.cljs$lang$applyTo = (function (seq45848){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45848));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___45995 = arguments.length;
var i__5770__auto___45996 = (0);
while(true){
if((i__5770__auto___45996 < len__5769__auto___45995)){
args__5775__auto__.push((arguments[i__5770__auto___45996]));

var G__45997 = (i__5770__auto___45996 + (1));
i__5770__auto___45996 = G__45997;
continue;
} else {
}
break;
...
(re_frisk.ui.components.splits.v_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__45944){
var map__45945 = p__45944;
var map__45945__$1 = cljs.core.__destructure_map(map__45945);
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45945__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45945__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45945__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45945__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45945__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45945__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45945__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
var document__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45945__$1,new cljs.core.Keyword(null,"document","document",-1329188687),document);
...
var stop_drag = (function (){
if(cljs.core.truth_(on_split_change)){
var G__45950_45999 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__45950_45999) : on_split_change.call(null,G__45950_45999));
} else {
}
...
return (function() { 
var G__46034__delegate = function (p__45959){
var map__45960 = p__45959;
var map__45960__$1 = cljs.core.__destructure_map(map__45960);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var open_bottom_split_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"open-bottom-split?","open-bottom-split?",953160965));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var close_bottom_split_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"close-bottom-split?","close-bottom-split?",1606756910));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45960__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
while (G__46046__i < G__46046__a.length) {G__46046__a[G__46046__i] = arguments[G__46046__i + 0]; ++G__46046__i;}
  p__45959 = new cljs.core.IndexedSeq(G__46046__a,0,null);
} 
return G__46034__delegate.call(this,p__45959);};
G__46034.cljs$lang$maxFixedArity = 0;
G__46034.cljs$lang$applyTo = (function (arglist__46048){
var p__45959 = cljs.core.seq(arglist__46048);
return G__46034__delegate(p__45959);
});
...
/** @this {Function} */
(re_frisk.ui.components.splits.v_split.cljs$lang$applyTo = (function (seq45937){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45937));
}));
