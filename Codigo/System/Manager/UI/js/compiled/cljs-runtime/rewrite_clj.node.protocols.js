...
var rewrite_clj$node$protocols$Node$tag$dyn_18632 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_18632(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_18633 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_18633(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_18643 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_18643(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_18651 = (function (node,opts){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_18651(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_18655 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_18655(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_18660 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_18660(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18611_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__18611_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_18687 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_18687(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_18694 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_18694(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_18695 = (function (node,children){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_18695(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_18697 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_18697(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_18703 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_18703(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_18704 = (function (node,map_qualifier){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_18704(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_18705 = (function (node){
var x__5393__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_18705(node);
}
});
...
var map__18618 = cljs.core.meta(node);
var map__18618__$1 = cljs.core.__destructure_map(map__18618);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18618__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18618__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18618__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18618__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__18619,p__18620){
var vec__18624 = p__18619;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18624,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18624,(1),null);
var vec__18627 = p__18620;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18627,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18627,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__18630 = col_extent;
if((row_extent === (0))){
return (G__18630 + col);
} else {
return G__18630;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__18631 = rewrite_clj.node.protocols.children(node);
var G__18631__$1 = (((G__18631 == null))?null:cljs.core.first(G__18631));
if((G__18631__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__18631__$1);
}
} else {
