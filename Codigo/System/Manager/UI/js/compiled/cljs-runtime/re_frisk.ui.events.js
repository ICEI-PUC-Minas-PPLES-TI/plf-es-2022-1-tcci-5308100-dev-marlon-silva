...
return (function (p__47156,___$1){
var map__47157 = p__47156;
var map__47157__$1 = cljs.core.__destructure_map(map__47157);
var item = map__47157__$1;
var color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47157__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47157__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var app_db_diff = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47157__$1,new cljs.core.Keyword(null,"app-db-diff","app-db-diff",709588713));
var selected_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47157__$1,new cljs.core.Keyword(null,"selected?","selected?",-742502788));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47157__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var indx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47157__$1,new cljs.core.Keyword(null,"indx","indx",1571035590));
var search_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47157__$1,new cljs.core.Keyword(null,"search-filter","search-filter",274098807));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",-2123407586),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"href","href",-793805698),"#",new cljs.core.Keyword(null,"id","id",-1388402092),["events-list-item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(indx)].join(''),new cljs.core.Keyword(null,"class","class",-2030961996),["list-group-item",(cljs.core.truth_(selected_QMARK_)?" active":null)].join(''),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"padding","padding",1660304693),(5),new cljs.core.Keyword(null,"font-size","font-size",-1847940346),(13),new cljs.core.Keyword(null,"border-left-width","border-left-width",2037218085),(2),new cljs.core.Keyword(null,"padding-right","padding-right",-1250249681),(0),new cljs.core.Keyword(null,"white-space","white-space",-707351930),new cljs.core.Keyword(null,"pre","pre",2118456869),new cljs.core.Keyword(null,"width","width",-384071477),"100%"], null),(((((app_db_diff == null)) && (cljs.core.not(selected_QMARK_))))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opacity","opacity",397153780),"0.7"], null):null),((clojure.string.blank_QMARK_(color))?null:new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"border-left-color","border-left-color",-1166146583),["#",cljs.core.str.cljs$core$IFn$_invoke$arity$1(color)].join('')], null)),(cljs.core.truth_((function (){var and__5043__auto__ = (!(clojure.string.blank_QMARK_(search_filter)));
if(and__5043__auto__){
var and__5043__auto____$1 = (!((app_db_diff == null)));
if(and__5043__auto____$1){
return re_frisk.utils.get_from_diff(app_db_diff,re_frisk.filter.filter_parser.parse(search_filter));
} else {
...
})())?new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"border-left-width","border-left-width",2037218085),(4),new cljs.core.Keyword(null,"border-left-color","border-left-color",-1166146583),"#df691a"], null):null)], 0)),new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (event){
...
})], null),(cljs.core.truth_((function (){var and__5043__auto__ = op_type;
...
return (function (p__47198,___$1){
var map__47207 = p__47198;
var map__47207__$1 = cljs.core.__destructure_map(map__47207);
var item = map__47207__$1;
var trace_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47207__$1,new cljs.core.Keyword(null,"trace?","trace?",1730690679));
var op_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47207__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
if(cljs.core.truth_((function (){var and__5043__auto__ = trace_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.components.scroller,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-scroll","on-scroll",1590848677),(function (p1__47224_SHARP_){
var t = p1__47224_SHARP_.target;
...
})], null),(function (){var iter__5523__auto__ = (function re_frisk$ui$events$events_scroller_$_iter__47244(s__47245){
return (new cljs.core.LazySeq(null,(function (){
var s__47245__$1 = s__47245;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__47245__$1);
if(temp__5804__auto__){
var s__47245__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__47245__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__47245__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__47247 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__47246 = (0);
while(true){
if((i__47246 < size__5522__auto__)){
var item = cljs.core._nth(c__5521__auto__,i__47246);
cljs.core.chunk_append(b__47247,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.events.event_list_item,item,tool_state,checkbox_trace_val], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(item)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(checkbox_trace_val)].join('')], null)));

var G__47424 = (i__47246 + (1));
i__47246 = G__47424;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47247),re_frisk$ui$events$events_scroller_$_iter__47244(cljs.core.chunk_rest(s__47245__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47247),null);
}
} else {
var item = cljs.core.first(s__47245__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.events.event_list_item,item,tool_state,checkbox_trace_val], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["item",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(item)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(checkbox_trace_val)].join('')], null)),re_frisk$ui$events$events_scroller_$_iter__47244(cljs.core.rest(s__47245__$2)));
}
} else {
return null;
}
...
return iter__5523__auto__(cljs.core.deref(filtered_events));
})()], null);
})], null));
});
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47275_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__47275_SHARP_,new cljs.core.Keyword(null,"selected?","selected?",-742502788),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(tool_state),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"selected-event","selected-event",898030638),new cljs.core.Keyword(null,"indx","indx",1571035590)], null)),new cljs.core.Keyword(null,"indx","indx",1571035590).cljs$core$IFn$_invoke$arity$1(p1__47275_SHARP_)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"name","name",1843675177),(cljs.core.truth_(cljs.core.deref(truncate_checkbox_val))?new cljs.core.Keyword(null,"truncated-name","truncated-name",1771353320).cljs$core$IFn$_invoke$arity$1(p1__47275_SHARP_):cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword(null,"event","event",301435442).cljs$core$IFn$_invoke$arity$1(p1__47275_SHARP_)))),new cljs.core.Keyword(null,"search-filter","search-filter",274098807),new cljs.core.Keyword(null,"search-diff-path","search-diff-path",-507684436).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state)),new cljs.core.Keyword(null,"color","color",1011675173),cljs.core.get.cljs$core$IFn$_invoke$arity$2(clrs,cljs.core.first(new cljs.core.Keyword(null,"event","event",301435442).cljs$core$IFn$_invoke$arity$1(p1__47275_SHARP_)))], 0));
...
}),new cljs.core.Keyword(null,"active?","active?",459499776),false], null),"X"], null)], null)], null):null),(cljs.core.truth_(new cljs.core.Keyword(null,"events-opened?","events-opened?",-1069565502).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.box,new cljs.core.Keyword(null,"size","size",1098693007),"1",new cljs.core.Keyword(null,"child","child",623967545),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"height","height",1025178622),new cljs.core.Keyword(null,"auto","auto",-566279492),new cljs.core.Keyword(null,"padding","padding",1660304693),"0",new cljs.core.Keyword(null,"width","width",-384071477),"100%"], null),new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"search-diff-path","search-diff-path",-507684436).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state)),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"Search changes in db",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (e){
var val = e.target.value;
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(tool_state,cljs.core.assoc,new cljs.core.Keyword(null,"search-diff-path","search-diff-path",-507684436),val);
})], null)], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.components.components.small_button,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(tool_state,cljs.core.dissoc,new cljs.core.Keyword(null,"search-diff-path","search-diff-path",-507684436));
}),new cljs.core.Keyword(null,"active?","active?",459499776),false], null),"X"], null)], null)], null):null),(cljs.core.truth_(new cljs.core.Keyword(null,"events-opened?","events-opened?",-1069565502).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state)))?new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"gap","gap",80255254),"5px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.checkbox,new cljs.core.Keyword(null,"model","model",331153215),truncate_checkbox_val,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__47292_SHARP_){
return cljs.core.reset_BANG_(truncate_checkbox_val,p1__47292_SHARP_);
}),new cljs.core.Keyword(null,"label","label",1718410804),"truncate"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.checkbox,new cljs.core.Keyword(null,"model","model",331153215),checkbox_trace_val,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__47293_SHARP_){
return cljs.core.reset_BANG_(checkbox_trace_val,p1__47293_SHARP_);
}),new cljs.core.Keyword(null,"label","label",1718410804),"traces"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.gap,new cljs.core.Keyword(null,"size","size",1098693007),"100%"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.h_box,new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"type","type",1174270348),"text",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"height","height",1025178622),"20px",new cljs.core.Keyword(null,"padding","padding",1660304693),"0",new cljs.core.Keyword(null,"width","width",-384071477),"30px"], null),new cljs.core.Keyword(null,"value","value",305978217),cljs.core.deref(max_text_val),new cljs.core.Keyword(null,"placeholder","placeholder",-104873083),"max",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__47296_SHARP_){
return cljs.core.reset_BANG_(max_text_val,p1__47296_SHARP_.target.value);
...
}),new cljs.core.Keyword(null,"active?","active?",459499776),false], null),"X"], null)], null)], null)], null)], null):null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_frisk.ui.events.events_scroller,sorted_events,tool_state,cljs.core.deref(checkbox_trace_val)], null)], null)], null);
});
});
...
var G__47376 = new cljs.core.Keyword(null,"events-colors","events-colors",-428819032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state));
var fexpr__47375 = cljs.core.deref(evnt_key);
return (fexpr__47375.cljs$core$IFn$_invoke$arity$1 ? fexpr__47375.cljs$core$IFn$_invoke$arity$1(G__47376) : fexpr__47375.call(null,G__47376));
} else {
return "";
}
}));
...
var map__47404 = new cljs.core.Keyword(null,"selected-event","selected-event",898030638).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(tool_state));
var map__47404__$1 = cljs.core.__destructure_map(map__47404);
var item = map__47404__$1;
var subs_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47404__$1,new cljs.core.Keyword(null,"subs?","subs?",-2085240020));
