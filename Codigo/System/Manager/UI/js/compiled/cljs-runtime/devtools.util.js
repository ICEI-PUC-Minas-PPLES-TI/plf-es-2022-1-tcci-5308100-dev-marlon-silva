...
var len__5769__auto___10506 = arguments.length;
var i__5770__auto___10507 = (0);
while(true){
if((i__5770__auto___10507 < len__5769__auto___10506)){
args__5775__auto__.push((arguments[i__5770__auto___10507]));

var G__10510 = (i__5770__auto___10507 + (1));
i__5770__auto___10507 = G__10510;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__10417_10511 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__10418_10512 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__10419_10513 = true;
var _STAR_print_fn_STAR__temp_val__10420_10514 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__10419_10513);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__10420_10514);

try{var _STAR_print_level_STAR__orig_val__10421_10515 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__10422_10516 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__10422_10516);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__10421_10515);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__10418_10512);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__10417_10511);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq10416){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq10416));
}));
...
var new_formatters = current_formatters.filter((function (p1__10449_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__10449_SHARP_)));
}));
...
var G__10455_10529 = f;
var target__8463__auto___10530 = G__10455_10529;
if(cljs.core.truth_(target__8463__auto___10530)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10455_10529)].join(''),"\n","target__8463__auto__"].join('')));
}

(target__8463__auto___10530["toString"] = (function (){
...
var G__10458_10536 = "%c%s";
var G__10459_10537 = "color:transparent";
var G__10460_10538 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__10458_10536,G__10459_10537,G__10460_10538) : f.call(null,G__10458_10536,G__10459_10537,G__10460_10538));
...
var args__5775__auto__ = [];
var len__5769__auto___10540 = arguments.length;
var i__5770__auto___10541 = (0);
while(true){
if((i__5770__auto___10541 < len__5769__auto___10540)){
args__5775__auto__.push((arguments[i__5770__auto___10541]));

var G__10542 = (i__5770__auto___10541 + (1));
i__5770__auto___10541 = G__10542;
continue;
} else {
}
break;
...
var vec__10472 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10472,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10472,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__10544__delegate = function (add_fmt,add_args){
...
var G__10544 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__10545__i = 0, G__10545__a = new Array(arguments.length -  1);
while (G__10545__i < G__10545__a.length) {G__10545__a[G__10545__i] = arguments[G__10545__i + 1]; ++G__10545__i;}
  add_args = new cljs.core.IndexedSeq(G__10545__a,0,null);
} 
return G__10544__delegate.call(this,add_fmt,add_args);};
G__10544.cljs$lang$maxFixedArity = 1;
G__10544.cljs$lang$applyTo = (function (arglist__10546){
var add_fmt = cljs.core.first(arglist__10546);
var add_args = cljs.core.rest(arglist__10546);
return G__10544__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq10467){
var G__10468 = cljs.core.first(seq10467);
var seq10467__$1 = cljs.core.next(seq10467);
var G__10469 = cljs.core.first(seq10467__$1);
var seq10467__$2 = cljs.core.next(seq10467__$1);
var G__10470 = cljs.core.first(seq10467__$2);
var seq10467__$3 = cljs.core.next(seq10467__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10468,G__10469,G__10470,seq10467__$3);
}));
...
var seq__10488 = cljs.core.seq(features);
var chunk__10489 = null;
var count__10490 = (0);
var i__10491 = (0);
while(true){
if((i__10491 < count__10490)){
var feature = chunk__10489.cljs$core$IIndexed$_nth$arity$2(null,i__10491);
...
var G__10549 = seq__10488;
var G__10550 = chunk__10489;
var G__10551 = count__10490;
var G__10552 = (i__10491 + (1));
seq__10488 = G__10549;
chunk__10489 = G__10550;
count__10490 = G__10551;
i__10491 = G__10552;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__10488);
if(temp__5804__auto__){
var seq__10488__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__10488__$1)){
var c__5568__auto__ = cljs.core.chunk_first(seq__10488__$1);
var G__10553 = cljs.core.chunk_rest(seq__10488__$1);
var G__10554 = c__5568__auto__;
var G__10555 = cljs.core.count(c__5568__auto__);
var G__10556 = (0);
seq__10488 = G__10553;
chunk__10489 = G__10554;
count__10490 = G__10555;
i__10491 = G__10556;
continue;
} else {
var feature = cljs.core.first(seq__10488__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__10557 = cljs.core.next(seq__10488__$1);
var G__10558 = null;
var G__10559 = (0);
var G__10560 = (0);
seq__10488 = G__10557;
chunk__10489 = G__10558;
count__10490 = G__10559;
i__10491 = G__10560;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o10503 = temp__5802__auto__;
return (o10503["version"]);
} else {
return null;
}
})() == null);
