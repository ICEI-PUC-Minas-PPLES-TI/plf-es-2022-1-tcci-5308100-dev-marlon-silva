...
return [(function (){var pred__16097 = cljs.core.instance_QMARK_;
var expr__16098 = reactive_val;
if(cljs.core.truth_((pred__16097.cljs$core$IFn$_invoke$arity$2 ? pred__16097.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__16098) : pred__16097.call(null,reagent.ratom.RAtom,expr__16098)))){
return "ra";
} else {
if(cljs.core.truth_((pred__16097.cljs$core$IFn$_invoke$arity$2 ? pred__16097.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__16098) : pred__16097.call(null,reagent.ratom.RCursor,expr__16098)))){
return "rc";
} else {
if(cljs.core.truth_((pred__16097.cljs$core$IFn$_invoke$arity$2 ? pred__16097.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__16098) : pred__16097.call(null,reagent.ratom.Reaction,expr__16098)))){
return "rx";
} else {
if(cljs.core.truth_((pred__16097.cljs$core$IFn$_invoke$arity$2 ? pred__16097.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__16098) : pred__16097.call(null,reagent.ratom.Track,expr__16098)))){
return "tr";
} else {
return "other";
}
