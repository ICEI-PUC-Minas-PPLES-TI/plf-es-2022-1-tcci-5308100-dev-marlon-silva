...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_23701 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_23701(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_23703 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_23703(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_23706 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_23706(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_23707 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_23707(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_23709 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_23709(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_23712 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_23712(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_23713 = (function (this$,header){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_23713(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_23714 = (function (this$){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_23714(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_23719 = (function (this$,request){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_23719(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_23723 = (function (this$,response){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_23723(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k23687,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__23691 = k23687;
var G__23691__$1 = (((G__23691 instanceof cljs.core.Keyword))?G__23691.fqn:null);
switch (G__23691__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k23687,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__23692){
var vec__23693 = p__23692;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23693,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23693,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__23686){
var self__ = this;
var G__23686__$1 = this;
return (new cljs.core.RecordIter((0),G__23686__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this23688,other23689){
var self__ = this;
var this23688__$1 = this;
return (((!((other23689 == null)))) && ((((this23688__$1.constructor === other23689.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23688__$1.status,other23689.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23688__$1.body,other23689.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23688__$1.status_text,other23689.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23688__$1.headers,other23689.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23688__$1.was_aborted,other23689.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23688__$1.__extmap,other23689.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k23687){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k23687);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__23686){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__23697 = cljs.core.keyword_identical_QMARK_;
var expr__23698 = k__5352__auto__;
if(cljs.core.truth_((pred__23697.cljs$core$IFn$_invoke$arity$2 ? pred__23697.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__23698) : pred__23697.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__23698)))){
return (new ajax.protocols.Response(G__23686,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23697.cljs$core$IFn$_invoke$arity$2 ? pred__23697.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__23698) : pred__23697.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__23698)))){
return (new ajax.protocols.Response(self__.status,G__23686,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23697.cljs$core$IFn$_invoke$arity$2 ? pred__23697.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__23698) : pred__23697.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__23698)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__23686,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23697.cljs$core$IFn$_invoke$arity$2 ? pred__23697.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__23698) : pred__23697.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__23698)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__23686,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__23697.cljs$core$IFn$_invoke$arity$2 ? pred__23697.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__23698) : pred__23697.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__23698)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__23686,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__23686),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__23686){
var self__ = this;
var this__5342__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__23686,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__23690){
var extmap__5385__auto__ = (function (){var G__23700 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__23690,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__23690)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23700);
} else {
return G__23700;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__23690),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__23690),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__23690),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__23690),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__23690),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
