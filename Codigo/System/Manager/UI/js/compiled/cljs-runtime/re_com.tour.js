...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__44730_SHARP_,p2__44731_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__44730_SHARP_,p2__44731_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__5523__auto__ = (function re_com$tour$initialise_tour_$_iter__44735(s__44736){
return (new cljs.core.LazySeq(null,(function (){
var s__44736__$1 = s__44736;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__44736__$1);
if(temp__5804__auto__){
var s__44736__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__44736__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__44736__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__44738 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__44737 = (0);
while(true){
if((i__44737 < size__5522__auto__)){
var step = cljs.core._nth(c__5521__auto__,i__44737);
cljs.core.chunk_append(b__44738,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__44803 = (i__44737 + (1));
i__44737 = G__44803;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__44738),re_com$tour$initialise_tour_$_iter__44735(cljs.core.chunk_rest(s__44736__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__44738),null);
}
} else {
var step = cljs.core.first(s__44736__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__44735(cljs.core.rest(s__44736__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__44761 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__44761.cljs$core$IFn$_invoke$arity$1 ? fexpr__44761.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__44761.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__44771 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__44771.cljs$core$IFn$_invoke$arity$1 ? fexpr__44771.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__44771.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__44772 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__44772.cljs$core$IFn$_invoke$arity$1 ? fexpr__44772.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__44772.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__44778 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__44778.cljs$core$IFn$_invoke$arity$1 ? fexpr__44778.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__44778.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__44779 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__44779.cljs$core$IFn$_invoke$arity$1 ? fexpr__44779.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__44779.call(null,tour));
})(),true);
} else {
return null;
}
