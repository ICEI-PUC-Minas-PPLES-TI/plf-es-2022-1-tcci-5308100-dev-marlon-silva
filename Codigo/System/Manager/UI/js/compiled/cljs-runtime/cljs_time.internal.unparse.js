...
var periods__$1 = cljs.core.vec((function (){var G__42476 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42474_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__42474_SHARP_,(0),(3));
}),G__42476);
} else {
return G__42476;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__42494){
var vec__42495 = p__42494;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42495,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42495,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__42498 = pattern;
switch (G__42498) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42498)].join('')));
...
switch (G__42510__$1) {
case "millis":
return (function (p1__42501_SHARP_){
return p1__42501_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__42502_SHARP_){
return p1__42502_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__42503_SHARP_){
return p1__42503_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__42504_SHARP_){
return p1__42504_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__42505_SHARP_){
return p1__42505_SHARP_.getHours();
});

break;
case "day":
return (function (p1__42506_SHARP_){
return p1__42506_SHARP_.getDate();
});

break;
case "month":
return (function (p1__42507_SHARP_){
return p1__42507_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__42509_SHARP_){
return p1__42509_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42510__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__42513){
var vec__42515 = p__42513;
...
var key = first__42517;
var args = seq__42516__$1;
var G__42519 = key;
...
break;
case "ordinal-suffix":
var vec__42520 = (function (){var G__42523 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__42523) : syntax_list.call(null,G__42523));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42520,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42519__$1)].join('')));
...
var d = value;
var G__42529 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__42530 = G__42529;
...
var unparser = first__42532;
var more = seq__42531__$1;
var s = "";
var d__$1 = d;
var G__42529__$1 = G__42529;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__42539 = G__42529__$1;
var seq__42540 = cljs.core.seq(vec__42539);
var first__42541 = cljs.core.first(seq__42540);
var seq__42540__$1 = cljs.core.next(seq__42540);
var unparser__$1 = first__42541;
var more__$1 = seq__42540__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__42542 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42542,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42542,(1),null);
var G__42580 = d__$3;
var G__42581 = more__$1;
var G__42582 = s__$3;
d__$1 = G__42580;
G__42529__$1 = G__42581;
s__$1 = G__42582;
continue;
}
break;
