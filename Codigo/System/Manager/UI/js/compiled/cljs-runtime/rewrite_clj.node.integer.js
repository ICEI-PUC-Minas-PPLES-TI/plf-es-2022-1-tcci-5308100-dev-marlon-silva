...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k18645,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k18645,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__18681){
var vec__18682 = p__18681;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18682,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18682,(1),null);
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18646,other18647){
var self__ = this;
var this18646__$1 = this;
return (((!((other18647 == null)))) && ((((this18646__$1.constructor === other18647.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18646__$1.value,other18647.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18646__$1.base,other18647.base)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18646__$1.__extmap,other18647.__extmap)))))))));
}));
...
var abs_value = (function (){var G__18721 = self__.value;
if((self__.value < (0))){
return (- G__18721);
} else {
return G__18721;
...
var prefix = (function (){var G__18730 = cljs.core.long$(self__.base);
switch (G__18730) {
case (8):
return "0";
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k18645){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k18645);

}
}));

(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__18644){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__18743 = cljs.core.keyword_identical_QMARK_;
var expr__18744 = k__5352__auto__;
if(cljs.core.truth_((pred__18743.cljs$core$IFn$_invoke$arity$2 ? pred__18743.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__18744) : pred__18743.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__18744)))){
return (new rewrite_clj.node.integer.IntNode(G__18644,self__.base,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__18743.cljs$core$IFn$_invoke$arity$2 ? pred__18743.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"base","base",185279322),expr__18744) : pred__18743.call(null,new cljs.core.Keyword(null,"base","base",185279322),expr__18744)))){
return (new rewrite_clj.node.integer.IntNode(self__.value,G__18644,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__18644),null));
}
}
}));
...
(rewrite_clj.node.integer.IntNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__18644){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.integer.IntNode(self__.value,self__.base,G__18644,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.integer.map__GT_IntNode = (function rewrite_clj$node$integer$map__GT_IntNode(G__18652){
var extmap__5385__auto__ = (function (){var G__18757 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__18652,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"base","base",185279322)], 0));
if(cljs.core.record_QMARK_(G__18652)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__18757);
} else {
return G__18757;
}
})();
return (new rewrite_clj.node.integer.IntNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__18652),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(G__18652),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
