...
var G__42673 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(choices,new_index);
return (id_fn.cljs$core$IFn$_invoke$arity$1 ? id_fn.cljs$core$IFn$_invoke$arity$1(G__42673) : id_fn.call(null,G__42673));
} else {
return null;
}
});
...
var group_headers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42674_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"group","group",582596132)],[cljs.core.gensym.cljs$core$IFn$_invoke$arity$0(),p1__42674_SHARP_]);
...
}catch (e42686){if((e42686 instanceof Object)){
var e = e42686;
return null;
} else {
throw e42686;
...
var len__5769__auto___42867 = arguments.length;
var i__5770__auto___42868 = (0);
while(true){
if((i__5770__auto___42868 < len__5769__auto___42867)){
args__5775__auto__.push((arguments[i__5770__auto___42868]));

var G__42869 = (i__5770__auto___42868 + (1));
i__5770__auto___42868 = G__42869;
continue;
} else {
}
break;
...
(re_com.dropdown.insert.cljs$core$IFn$_invoke$arity$variadic = (function (p__42697){
var map__42698 = p__42697;
var map__42698__$1 = cljs.core.__destructure_map(map__42698);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42698__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var sel_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42698__$1,new cljs.core.Keyword(null,"sel-start","sel-start",175359789));
var sel_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42698__$1,new cljs.core.Keyword(null,"sel-end","sel-end",81085265));
var ins = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42698__$1,new cljs.core.Keyword(null,"ins","ins",-1021983570));
...
/** @this {Function} */
(re_com.dropdown.insert.cljs$lang$applyTo = (function (seq42695){
...
var args__5775__auto__ = [];
var len__5769__auto___42870 = arguments.length;
var i__5770__auto___42871 = (0);
while(true){
if((i__5770__auto___42871 < len__5769__auto___42870)){
args__5775__auto__.push((arguments[i__5770__auto___42871]));

var G__42872 = (i__5770__auto___42871 + (1));
i__5770__auto___42871 = G__42872;
continue;
} else {
}
break;
...
(re_com.dropdown.auto_complete.cljs$core$IFn$_invoke$arity$variadic = (function (p__42724){
var map__42725 = p__42724;
var map__42725__$1 = cljs.core.__destructure_map(map__42725);
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42725__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42725__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var sel_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42725__$1,new cljs.core.Keyword(null,"sel-start","sel-start",175359789));
var sel_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42725__$1,new cljs.core.Keyword(null,"sel-end","sel-end",81085265));
var ins = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42725__$1,new cljs.core.Keyword(null,"ins","ins",-1021983570));
...
var find = (function (p1__42706_SHARP_){
return goog.string.caseInsensitiveStartsWith(p1__42706_SHARP_,text_SINGLEQUOTE_);
});
...
/** @this {Function} */
(re_com.dropdown.auto_complete.cljs$lang$applyTo = (function (seq42718){
var self__5755__auto__ = this;
...
var G__42728_42874 = event.target.value;
(set_filter_text.cljs$core$IFn$_invoke$arity$1 ? set_filter_text.cljs$core$IFn$_invoke$arity$1(G__42728_42874) : set_filter_text.call(null,G__42728_42874));
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta(re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__42729_SHARP_){
var node = reagent.dom.dom_node(p1__42729_SHARP_).firstChild;
return node.focus();
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__42730_SHARP_){
var node = reagent.dom.dom_node(p1__42730_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var text = (cljs.core.truth_(cljs.core.deref(internal_model))?(function (){var G__42731 = re_com.util.item_for_id.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(internal_model),choices,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"id-fn","id-fn",316222798),id_fn], 0));
return (label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(G__42731) : label_fn.call(null,G__42731));
})():placeholder);
...
var ins_SINGLEQUOTE_ = (function (){var G__42732 = ins;
...
return re_com.dropdown.capitalize_first_letter(G__42732);
} else {
return G__42732;
}
})();
...
var map__42733 = auto_complete_ret;
var map__42733__$1 = cljs.core.__destructure_map(map__42733);
var text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42733__$1,new cljs.core.Keyword(null,"text","text",-1790561697));
var sel_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42733__$1,new cljs.core.Keyword(null,"sel-start","sel-start",175359789));
var sel_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42733__$1,new cljs.core.Keyword(null,"sel-end","sel-end",81085265));
...
var ins_42877 = event.key;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(ins_42877),(1))){
re_com.dropdown.handle_free_text_insertion(event,ins_42877,auto_complete_QMARK_,capitalize_QMARK_,choices,internal_model,free_text_sel_range,free_text_change);
} else {
}

return null;
}),placeholder,disabled_QMARK_,(function (p1__42736_SHARP_){
return cljs.core.reset_BANG_(free_text_input,p1__42736_SHARP_);
}),(function (event){
...
var ins_42878 = event.clipboardData.getData("Text");
re_com.dropdown.handle_free_text_insertion(event,ins_42878,auto_complete_QMARK_,capitalize_QMARK_,choices,internal_model,free_text_sel_range,free_text_change);
...
var value_42880 = event.target.value;
var G__42751_42881 = (function (){var G__42752 = value_42880;
if(cljs.core.truth_(capitalize_QMARK_)){
return re_com.dropdown.capitalize_first_letter(G__42752);
} else {
return G__42752;
}
})();
(free_text_change.cljs$core$IFn$_invoke$arity$1 ? free_text_change.cljs$core$IFn$_invoke$arity$1(G__42751_42881) : free_text_change.call(null,G__42751_42881));
 ...
 */
re_com.dropdown.free_text_dropdown_top = cljs.core.with_meta(re_com.dropdown.free_text_dropdown_top_base,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__42754_SHARP_){
var vec__42755 = reagent.core.argv(p1__42754_SHARP_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42755,(0),null);
var free_text_input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42755,(1),null);
var select_free_text_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42755,(2),null);
var free_text_focused_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42755,(3),null);
var free_text_sel_range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42755,(4),null);
...
var callback = (function (p__42763){
var map__42764 = p__42763;
var map__42764__$1 = cljs.core.__destructure_map(map__42764);
var args = map__42764__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42764__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42764__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
var G__42767 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"filter-text","filter-text",-381699202),text,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668),regex_filter_QMARK_], null);
var G__42768 = (function (p1__42759_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"result","result",1415092211),p1__42759_SHARP_], null));
});
var G__42769 = (function (p1__42760_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__42760_SHARP_], null));
});
return (choices.cljs$core$IFn$_invoke$arity$3 ? choices.cljs$core$IFn$_invoke$arity$3(G__42767,G__42768,G__42769) : choices.call(null,G__42767,G__42768,G__42769));
});
/**
...
var temp__5804__auto___42885 = new cljs.core.Keyword(null,"timer","timer",-1266967739).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
if(cljs.core.truth_(temp__5804__auto___42885)){
var timer_42886 = temp__5804__auto___42885;
clearTimeout(timer_42886);
} else {
}
...
(re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__42798){
var map__42800 = p__42798;
var map__42800__$1 = cljs.core.__destructure_map(map__42800);
var args = map__42800__$1;
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42800__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42800__$1,new cljs.core.Keyword(null,"model","model",331153215));
var regex_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42800__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var debounce_delay = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42800__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982),(250));
var just_drop_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42800__$1,new cljs.core.Keyword(null,"just-drop?","just-drop?",-378249297));
...
var set_filter_text = (function (text,p__42808,debounce_QMARK_){
var map__42809 = p__42808;
var map__42809__$1 = cljs.core.__destructure_map(map__42809);
var args__$1 = map__42809__$1;
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42809__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
...
var G__42812 = cljs.core.deref(node);
var G__42812__$1 = (((G__42812 == null))?null:G__42812.getElementsByClassName("chosen-single"));
var G__42812__$2 = (((G__42812__$1 == null))?null:G__42812__$1.item((0)));
if((G__42812__$2 == null)){
return null;
} else {
return G__42812__$2.focus();
}
});
load_choices("",regex_filter_QMARK_,false);

return (function() { 
var re_com$dropdown$single_dropdown_render__delegate = function (p__42815){
var map__42816 = p__42815;
var map__42816__$1 = cljs.core.__destructure_map(map__42816);
var args__$1 = map__42816__$1;
var est_item_height = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42816__$1,new cljs.core.Keyword(null,"est-item-height","est-item-height",-264466439),(30));
var auto_complete_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"auto-complete?","auto-complete?",979505177));
var group_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42816__$1,new cljs.core.Keyword(null,"group-fn","group-fn",129203707),new cljs.core.Keyword(null,"group","group",582596132));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var i18n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"i18n","i18n",-563422499));
var tooltip = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"tooltip","tooltip",-1809677058));
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"model","model",331153215));
var free_text_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"free-text?","free-text?",1157444543));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42816__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263),new cljs.core.Keyword(null,"label","label",1718410804));
var tab_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"tab-index","tab-index",895755393));
var can_drop_above_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"can-drop-above?","can-drop-above?",-1140582782));
var repeat_change_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"repeat-change?","repeat-change?",-961675100));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var title_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"title?","title?",-1510254555));
var render_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42816__$1,new cljs.core.Keyword(null,"render-fn","render-fn",398796518),label_fn);
var cancelable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42816__$1,new cljs.core.Keyword(null,"cancelable?","cancelable?",-986378679),true);
var set_to_filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"set-to-filter","set-to-filter",1270184073));
var parts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"parts","parts",849007691));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_drop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491));
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var choices__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42816__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798),new cljs.core.Keyword(null,"id","id",-1388402092));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var filter_placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"filter-placeholder","filter-placeholder",-1736876526));
var debounce_delay__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var enter_drop_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__42816__$1,new cljs.core.Keyword(null,"enter-drop?","enter-drop?",1054029717),true);
var tooltip_position = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"tooltip-position","tooltip-position",936197013));
var filter_box_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"filter-box?","filter-box?",-1157583688));
var capitalize_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42816__$1,new cljs.core.Keyword(null,"capitalize?","capitalize?",-2078576456));
...
var G__42831 = cljs.core.deref(internal_model);
return (on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__42831) : on_change.call(null,G__42831));
} else {
return null;
}
});
var callback = (function (p1__42770_SHARP_){
cljs.core.reset_BANG_(internal_model,(function (){var G__42832 = p1__42770_SHARP_;
...
return re_com.dropdown.capitalize_first_letter(G__42832);
} else {
return G__42832;
}
})());
...
var current_drop_showing_QMARK__42949 = cljs.core.deref(drop_showing_QMARK_);
if(cljs.core.truth_(current_drop_showing_QMARK__42949)){
focus_free_text();
} else {
}
...
cljs.core.reset_BANG_(drop_showing_QMARK_,cljs.core.not(current_drop_showing_QMARK__42949));
}
...
var free_text_change = (function (p1__42771_SHARP_){
cljs.core.reset_BANG_(internal_model,p1__42771_SHARP_);
...
var drop_was_showing_QMARK__43033 = cljs.core.deref(drop_showing_QMARK_);
call_on_change();
...
if(cljs.core.truth_((function (){var and__5043__auto__ = drop_was_showing_QMARK__43033;
if(cljs.core.truth_(and__5043__auto__)){
...
var key_handler = (function (p1__42776_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__42842 = p1__42776_SHARP_.which;
switch (G__42842) {
case (13):
return press_enter();
...
break;
case (9):
return press_tab(p1__42776_SHARP_.shiftKey);
...
})())?new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.dropdown.filter_text_box,filter_box_QMARK_,filter_text,key_handler,drop_showing_QMARK_,(function (p1__42778_SHARP_){
return set_filter_text(p1__42778_SHARP_,args__$1,true);
...
})())?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["error rc-dropdown-choices-error ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"class","class",-2030961996)], null)))].join(''),new cljs.core.Keyword(null,"style","style",-496642736),cljs.core.get_in.cljs$core$IFn$_invoke$arity$3(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"style","style",-496642736)], null),cljs.core.PersistentArrayMap.EMPTY)], null),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(parts,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"choices-error","choices-error",2121956865),new cljs.core.Keyword(null,"attr","attr",-604132353)], null))], 0)),new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state))], null):(((cljs.core.count(filtered_choices) > (0)))?(function (){var vec__42858 = re_com.dropdown.choices_with_group_headings(filtered_choices,group_fn);
var group_names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42858,(0),null);
var group_opt_lists = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42858,(1),null);
...
var make_choices = (function (p1__42782_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(make_a_choice,p1__42782_SHARP_);
});
...
var ___$2 = (cljs.core.truth_(on_drop)?cljs.core.add_watch(drop_showing_QMARK_,new cljs.core.Keyword(null,"on-drop","on-drop",1867868491),(function (p1__42786_SHARP_,p2__42788_SHARP_,p3__42784_SHARP_,p4__42785_SHARP_){
if(cljs.core.truth_((function (){var and__5043__auto__ = cljs.core.not(p3__42784_SHARP_);
if(and__5043__auto__){
return p4__42785_SHARP_;
} else {
return and__5043__auto__;
}
})())){
...
while (G__43173__i < G__43173__a.length) {G__43173__a[G__43173__i] = arguments[G__43173__i + 0]; ++G__43173__i;}
  p__42815 = new cljs.core.IndexedSeq(G__43173__a,0,null);
} 
return re_com$dropdown$single_dropdown_render__delegate.call(this,p__42815);};
re_com$dropdown$single_dropdown_render.cljs$lang$maxFixedArity = 0;
re_com$dropdown$single_dropdown_render.cljs$lang$applyTo = (function (arglist__43174){
var p__42815 = cljs.core.seq(arglist__43174);
return re_com$dropdown$single_dropdown_render__delegate(p__42815);
});
...
/** @this {Function} */
(re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq42791){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq42791));
}));
