...
if(typeof x === 'string'){
var vec__39717 = zprint.zprint.determine_ending_split_lines(x);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39717,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39717,(1),null);
...
try{return ["\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__39726 = zprint.config.merge_deep.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325),true], null),options], 0));
var G__39727 = coll_str;
return (zprint.core.zprint_str_internal.cljs$core$IFn$_invoke$arity$2 ? zprint.core.zprint_str_internal.cljs$core$IFn$_invoke$arity$2(G__39726,G__39727) : zprint.core.zprint_str_internal.call(null,G__39726,G__39727));
})())].join('');
}catch (e39723){var e = e39723;
return coll_str;
}});
/**
 * If we are running in zipper mode, do an internal version of zprint
...
var vec__39730 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options,null], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?(function (){var vec__39733 = zprint.core.get_zipper(options,coll);
var form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39733,(0),null);
var line_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39733,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [form,options,line_end], null);
})():(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__39736 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39736,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39736,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39730,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39730,(1),null);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39730,(2),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__39740){
var vec__39741 = p__39740;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39741,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39741,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39744,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39744,(1),null);
...
var configure_errors = (cljs.core.truth_(new cljs.core.Keyword(null,"configured?","configured?",642178633).cljs$core$IFn$_invoke$arity$1(zprint.config.get_options()))?null:zprint.core.configure_all_BANG_());
var vec__39748 = zprint.config.config_and_validate.cljs$core$IFn$_invoke$arity$4("determine-options",null,zprint.config.get_options(),rest_options);
var actual_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39748,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39748,(1),null);
var errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39748,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__39754){
var vec__39756 = p__39754;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39756,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39756,(1),null);
...
var vec__39759 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39759,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39759,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39759,(2),null);
...
var vec__39771 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39771,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39771,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39771,(2),null);
var tuple = vec__39771;
...
var G__39890 = cljs.core.next(style_vec);
var G__39891 = ends_w_blanks_QMARK_;
var G__39892 = tuple;
var G__39893 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__39890;
previous_ends_w_blanks_QMARK_ = G__39891;
previous_tuple = G__39892;
out = G__39893;
continue;
}
break;
 ...
 */
zprint.core.real_le = (function zprint$core$real_le(real_le_length,p__39774){
var vec__39775 = p__39774;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39775,(0),null);
var element = vec__39775;
...
var len__5769__auto___39894 = arguments.length;
var i__5770__auto___39895 = (0);
while(true){
if((i__5770__auto___39895 < len__5769__auto___39894)){
args__5775__auto__.push((arguments[i__5770__auto___39895]));

var G__39896 = (i__5770__auto___39895 + (1));
i__5770__auto___39895 = G__39896;
continue;
} else {
}
break;
...
var vec__39787 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39787,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39787,(1),null);
...
var vec__39790 = zprint.zprint.determine_ending_split_lines(coll);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39790,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39790,(1),null);
...
var result = (function (){var G__39793 = zprint.core.parse_string_all_options(rest_options);
var G__39794 = zprint.core.zprint_str_internal;
var G__39795 = ":parse-string-all? call";
var G__39796 = rewrite_clj.zip.edn_STAR_.cljs$core$IFn$_invoke$arity$1(rewrite_clj.parser.parse_string_all(coll__$1));
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__39793,G__39794,G__39795,G__39796) : zprint.core.process_multiple_forms.call(null,G__39793,G__39794,G__39795,G__39796));
})();
...
var vec__39797 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39797,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39797,(1),null);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39797,(2),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq39783){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39784,G__39785,seq39783__$2);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___39902 = arguments.length;
var i__5770__auto___39903 = (0);
while(true){
if((i__5770__auto___39903 < len__5769__auto___39902)){
args__5775__auto__.push((arguments[i__5770__auto___39903]));

var G__39904 = (i__5770__auto___39903 + (1));
i__5770__auto___39903 = G__39904;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq39800){
var G__39801 = cljs.core.first(seq39800);
var seq39800__$1 = cljs.core.next(seq39800);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39801,seq39800__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___39905 = arguments.length;
var i__5770__auto___39906 = (0);
while(true){
if((i__5770__auto___39906 < len__5769__auto___39905)){
args__5775__auto__.push((arguments[i__5770__auto___39906]));

var G__39907 = (i__5770__auto___39906 + (1));
i__5770__auto___39906 = G__39907;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq39802){
var G__39803 = cljs.core.first(seq39802);
var seq39802__$1 = cljs.core.next(seq39802);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39803,seq39802__$1);
}));
...
var args__5775__auto__ = [];
var len__5769__auto___39908 = arguments.length;
var i__5770__auto___39909 = (0);
while(true){
if((i__5770__auto___39909 < len__5769__auto___39908)){
args__5775__auto__.push((arguments[i__5770__auto___39909]));

var G__39912 = (i__5770__auto___39909 + (1));
i__5770__auto___39909 = G__39912;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq39804){
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq39806){
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__39809,form){
var vec__39810 = p__39809;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39810,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39810,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39810,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39810,(3),null);
var previous_newline_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39810,(4),null);
...
var vec__39814 = (cljs.core.truth_((function (){var and__5043__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__5043__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39814,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39814,(1),null);
...
var G__39945 = cljs.core.next(sos);
var G__39946 = comment_QMARK_;
var G__39947 = (function (){var or__5045__auto__ = (!(empty_string_QMARK_));
if(or__5045__auto__){
return or__5045__auto__;
} else {
...
var G__39948 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__39945;
previous_comment_QMARK_ = G__39946;
start_interpolating_QMARK_ = G__39947;
out = G__39948;
continue;
}
break;
...
try{var vec__39825 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39825,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39825,(1),null);
var vec__39828 = zprint.zprint.determine_ending_split_lines(file_str__$1);
var line_ending = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39828,(0),null);
var lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39828,(1),null);
...
var vec__39831 = (cljs.core.truth_((function (){var or__5045__auto__ = range_start__$1;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39831,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39831,(1),null);
...
var vec__39834 = (cljs.core.truth_((function (){var and__5043__auto__ = actual_start;
if(cljs.core.truth_(and__5043__auto__)){
return actual_end;
} else {
return and__5043__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39834,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39834,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39834,(2),null);
...
var vec__39837 = (cljs.core.truth_(range_output_QMARK_)?(function (){var actual_start__$1 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(actual_end,(-1)))?actual_start:(function (){var x__5130__auto__ = actual_start;
...
var corrected_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39837,(0),null);
var corrected_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39837,(1),null);
