...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k24154,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k24154,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__24165){
var vec__24166 = p__24165;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24166,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__24166,(1),null);
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__24153){
var self__ = this;
var G__24153__$1 = this;
return (new cljs.core.RecordIter((0),G__24153__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pre","pre",2118456869)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this24155,other24156){
var self__ = this;
var this24155__$1 = this;
return (((!((other24156 == null)))) && ((((this24155__$1.constructor === other24156.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24155__$1.pre,other24156.pre)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this24155__$1.__extmap,other24156.__extmap)))))));
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k24154){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k24154);

}
}));

(schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__24153){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__24194 = cljs.core.keyword_identical_QMARK_;
var expr__24195 = k__5352__auto__;
if(cljs.core.truth_((pred__24194.cljs$core$IFn$_invoke$arity$2 ? pred__24194.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pre","pre",2118456869),expr__24195) : pred__24194.call(null,new cljs.core.Keyword(null,"pre","pre",2118456869),expr__24195)))){
return (new schema.spec.leaf.LeafSpec(G__24153,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__24153),null));
}
}));
...
(schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__24153){
var self__ = this;
var this__5342__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__24153,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__24158){
var extmap__5385__auto__ = (function (){var G__24202 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__24158,new cljs.core.Keyword(null,"pre","pre",2118456869));
if(cljs.core.record_QMARK_(G__24158)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__24202);
} else {
return G__24202;
}
})();
return (new schema.spec.leaf.LeafSpec(new cljs.core.Keyword(null,"pre","pre",2118456869).cljs$core$IFn$_invoke$arity$1(G__24158),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
