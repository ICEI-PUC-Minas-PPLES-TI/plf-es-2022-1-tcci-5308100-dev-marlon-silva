...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k19504,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__19512 = k19504;
var G__19512__$1 = (((G__19512 instanceof cljs.core.Keyword))?G__19512.fqn:null);
switch (G__19512__$1) {
case "tag":
return self__.tag;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k19504,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__19513){
var vec__19514 = p__19513;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19514,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19514,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__19503){
var self__ = this;
var G__19503__$1 = this;
return (new cljs.core.RecordIter((0),G__19503__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this19505,other19506){
var self__ = this;
var this19505__$1 = this;
return (((!((other19506 == null)))) && ((((this19505__$1.constructor === other19506.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19505__$1.tag,other19506.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19505__$1.prefix,other19506.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19505__$1.sym,other19506.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19505__$1.children,other19506.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19505__$1.__extmap,other19506.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k19504){
var self__ = this;
var this__5350__auto____$1 = this;
var G__19555 = k19504;
var G__19555__$1 = (((G__19555 instanceof cljs.core.Keyword))?G__19555.fqn:null);
switch (G__19555__$1) {
case "tag":
case "prefix":
case "sym":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k19504);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__19503){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__19605 = cljs.core.keyword_identical_QMARK_;
var expr__19606 = k__5352__auto__;
if(cljs.core.truth_((pred__19605.cljs$core$IFn$_invoke$arity$2 ? pred__19605.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__19606) : pred__19605.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__19606)))){
return (new rewrite_clj.node.quote.QuoteNode(G__19503,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__19605.cljs$core$IFn$_invoke$arity$2 ? pred__19605.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__19606) : pred__19605.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__19606)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__19503,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__19605.cljs$core$IFn$_invoke$arity$2 ? pred__19605.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__19606) : pred__19605.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__19606)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__19503,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__19605.cljs$core$IFn$_invoke$arity$2 ? pred__19605.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__19606) : pred__19605.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__19606)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__19503,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__19503),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__19503){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__19503,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__19508){
var extmap__5385__auto__ = (function (){var G__19608 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__19508,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__19508)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__19608);
} else {
return G__19608;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__19508),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__19508),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__19508),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__19508),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
var G__19641 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__19641;
continue;
}
break;
...
var G__19643 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__19643;
continue;
}
break;
...
var G__19644 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__19644;
continue;
}
break;
...
var G__19645 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__19645;
continue;
}
break;
