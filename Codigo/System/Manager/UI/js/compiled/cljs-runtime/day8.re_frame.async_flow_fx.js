...
day8.re_frame.async_flow_fx._STAR_DEBUG_QMARK_ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(false);
day8.re_frame.async_flow_fx.enable_debug_QMARK_ = (function day8$re_frame$async_flow_fx$enable_debug_QMARK_(enabled_QMARK_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(day8.re_frame.async_flow_fx._STAR_DEBUG_QMARK_,(function (){
return cljs.core.identity(enabled_QMARK_);
}));
});
/**
 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__23692){
var vec__23693 = p__23692;
var seq__23694 = cljs.core.seq(vec__23693);
var first__23695 = cljs.core.first(seq__23694);
var seq__23694__$1 = cljs.core.next(seq__23694);
var k = first__23695;
var ks = seq__23694__$1;
var keys = vec__23693;
if(ks){
...
var G__23697 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__23698 = now_seen_events;
var fexpr__23696 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__23696.cljs$core$IFn$_invoke$arity$2 ? fexpr__23696.cljs$core$IFn$_invoke$arity$2(G__23697,G__23698) : fexpr__23696.call(null,G__23697,G__23698));
...
var temp__5802__auto__ = (day8.re_frame.async_flow_fx.map_when__GT_fn.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame.async_flow_fx.map_when__GT_fn.cljs$core$IFn$_invoke$arity$1(when_kw) : day8.re_frame.async_flow_fx.map_when__GT_fn.call(null,when_kw));
if(cljs.core.truth_(temp__5802__auto__)){
var when_fn = temp__5802__auto__;
return when_fn;
} else {
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__23699){
var map__23700 = p__23699;
var map__23700__$1 = cljs.core.__destructure_map(map__23700);
var rule = map__23700__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23700__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23700__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23700__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23700__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23700__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23700__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23700__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__23701 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5045__auto__ = id;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return index;
}
})(),new cljs.core.Keyword(null,"halt?","halt?",-1110658247),(function (){var or__5045__auto__ = halt_QMARK_;
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
} else {
return false;
...
var G__23701__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23701,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__23701);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23701__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__23701__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23702__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23702__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__23703){
var map__23704 = p__23703;
var map__23704__$1 = cljs.core.__destructure_map(map__23704);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23704__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23704__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23704__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23704__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
var debug_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__23704__$1,new cljs.core.Keyword(null,"debug?","debug?",-1831756173),cljs.core.deref(day8.re_frame.async_flow_fx._STAR_DEBUG_QMARK_));
if((((db_path == null)) || (cljs.core.vector_QMARK_(db_path)))){
} else {
throw (new Error(["Assert failed: ","async-flow: optional db-path parameter must be a vector","\n","(or (nil? db-path) (vector? db-path))"].join('')));
}
...
if(cljs.core.truth_(cljs.core.some(new cljs.core.Keyword(null,"halt?","halt?",-1110658247),rules__$1))){
} else {
re_frame.core.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"warn","warn",-436710552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([goog.string.format("async-flow [%s] %s - has no rules with :halt?",id,cljs.core.system_time())], 0));
}

return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__23705,p__23706){
...
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23708,(1),null);
var event_v = vec__23708;
var pred__23711 = cljs.core._EQ_;
var expr__23712 = event_type;
if(cljs.core.truth_((pred__23711.cljs$core$IFn$_invoke$arity$2 ? pred__23711.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"setup","setup",1987730512),expr__23712) : pred__23711.call(null,new cljs.core.Keyword(null,"setup","setup",1987730512),expr__23712)))){
if(cljs.core.truth_(debug_QMARK_)){
re_frame.core.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"debug","debug",-1608172596),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([goog.string.format("async-flow [%s :setup]",id),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"ts","ts",1617209904),cljs.core.system_time(),new cljs.core.Keyword(null,"signal","signal",-1984951589),event_type], null)], 0));
} else {
}
...
var vec__23719 = event_v;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23719,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23719,(1),null);
var map__23722 = get_state(db);
var map__23722__$1 = cljs.core.__destructure_map(map__23722);
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23722__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23722__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"db","db",993250759),new_db], null),((cljs.core.seq(new_dispatches))?(function (){
if(cljs.core.truth_(debug_QMARK_)){
re_frame.core.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"debug","debug",-1608172596),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([goog.string.format("async-flow [%s :dispatching]",id),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"ts","ts",1617209904),cljs.core.system_time(),new cljs.core.Keyword(null,"signal","signal",-1984951589),event_type,new cljs.core.Keyword(null,"dispatched","dispatched",-305136936),new_dispatches], null)], 0));
} else {
}

return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),new_dispatches], null);
})()
:null),(cljs.core.truth_(halt_QMARK_)?(function (){
if(cljs.core.truth_(debug_QMARK_)){
re_frame.core.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"debug","debug",-1608172596),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([goog.string.format("async-flow [%s :halting]",id),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),id,new cljs.core.Keyword(null,"ts","ts",1617209904),cljs.core.system_time(),new cljs.core.Keyword(null,"signal","signal",-1984951589),event_type,new cljs.core.Keyword(null,"rule","rule",729973257),cljs.core.filter.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"halt?","halt?",-1110658247),ready_rules)], null)], 0));
} else {
}
...
var temp__5802__auto__ = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(flow);
if(cljs.core.truth_(temp__5802__auto__)){
...
var vec__23734 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23734,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23734,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("day8.re-frame.async-flow-fx","notify","day8.re-frame.async-flow-fx/notify",-341606413),(function day8$re_frame$async_flow_fx$handler_COLON_notify(p__23737,p__23738){
var map__23739 = p__23737;
var map__23739__$1 = cljs.core.__destructure_map(map__23739);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23739__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__23740 = p__23738;
...
var _ = first__23742;
var first__23742__$1 = cljs.core.first(seq__23741__$1);
var seq__23741__$2 = cljs.core.next(seq__23741__$1);
var kw = first__23742__$1;
var others = seq__23741__$2;
return null;
}));
