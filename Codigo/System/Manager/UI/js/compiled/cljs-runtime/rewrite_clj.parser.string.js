...
if((c === "\n")){
var G__19774 = escape_QMARK_;
var G__19775 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__19774;
lines = G__19775;
continue;
} else {
buf.append(c);

var G__19777 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__19778 = lines;
escape_QMARK_ = G__19777;
lines = G__19778;
continue;
