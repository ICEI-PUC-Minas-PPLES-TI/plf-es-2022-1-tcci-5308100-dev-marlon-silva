...
var i__5770__auto___41059 = (0);
while(true){
if((i__5770__auto___41059 < len__5769__auto___41057)){
args__5775__auto__.push((arguments[i__5770__auto___41059]));

var G__41060 = (i__5770__auto___41059 + (1));
i__5770__auto___41059 = G__41060;
continue;
} else {
}
break;
...
if(cljs.core.every_QMARK_((function (p1__40981_SHARP_){
return (p1__40981_SHARP_ instanceof goog.date.Date);
}),args)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core._EQ_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40982_SHARP_){
return p1__40982_SHARP_.getTime();
}),args));
} else {
...
/** @this {Function} */
(cljs_time.internal.core._EQ_.cljs$lang$applyTo = (function (seq40983){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40983));
}));
...
var G__40989 = (cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([month,(1)], 0)))?(11):(month - (1)));
return (cljs_time.internal.core.days_in_month.cljs$core$IFn$_invoke$arity$1 ? cljs_time.internal.core.days_in_month.cljs$core$IFn$_invoke$arity$1(G__40989) : cljs_time.internal.core.days_in_month.call(null,G__40989));
});
cljs_time.internal.core.year_corrected_dim = (function cljs_time$internal$core$year_corrected_dim(year,month){
var G__40990 = cljs_time.internal.core.corrected_dim(month);
...
cljs_time.internal.core.valid_date_QMARK_ = (function cljs_time$internal$core$valid_date_QMARK_(p__41000){
var map__41001 = p__41000;
var map__41001__$1 = cljs.core.__destructure_map(map__41001);
var d = map__41001__$1;
var minutes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"minutes","minutes",1319166394));
var millis = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"millis","millis",-1338288387));
var day_of_week = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"day-of-week","day-of-week",1639326729));
var months = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"months","months",-45571637));
var days = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"days","days",-1394072564));
var weekyear = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"weekyear","weekyear",-74064500));
var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"seconds","seconds",-445266194));
var weekyear_week = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"weekyear-week","weekyear-week",795291571));
var hours = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"hours","hours",58380855));
var years = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41001__$1,new cljs.core.Keyword(null,"years","years",-1298579689));
...
throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("Date is not valid",new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"invalid-date","invalid-date",2030506573),new cljs.core.Keyword(null,"date","date",-1463434462),d,new cljs.core.Keyword(null,"errors","errors",-908790718),(function (){var G__41019 = cljs.core.PersistentArrayMap.EMPTY;
var G__41019__$1 = ((months_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41019,new cljs.core.Keyword(null,"months","months",-45571637),months):G__41019);
var G__41019__$2 = ((days_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41019__$1,new cljs.core.Keyword(null,"days","days",-1394072564),days):G__41019__$1);
var G__41019__$3 = ((hours_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41019__$2,new cljs.core.Keyword(null,"hours","hours",58380855),hours):G__41019__$2);
var G__41019__$4 = ((minutes_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41019__$3,new cljs.core.Keyword(null,"minutes","minutes",1319166394),minutes):G__41019__$3);
var G__41019__$5 = ((seconds_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41019__$4,new cljs.core.Keyword(null,"seconds","seconds",-445266194),seconds):G__41019__$4);
var G__41019__$6 = ((millis_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41019__$5,new cljs.core.Keyword(null,"millis","millis",-1338288387),millis):G__41019__$5);
var G__41019__$7 = ((weekyear_week_QMARK_ === false)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41019__$6,new cljs.core.Keyword(null,"weekyear-week","weekyear-week",795291571),weekyear_week):G__41019__$6);
if(day_of_week_QMARK_ === false){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__41019__$7,new cljs.core.Keyword(null,"day-of-week","day-of-week",1639326729),day_of_week);
} else {
return G__41019__$7;
}
})()], null));
...
return cljs.core.first(cljs.core.keep_indexed.cljs$core$IFn$_invoke$arity$2((function (p1__41026_SHARP_,p2__41025_SHARP_){
if(cljs.core.truth_(cljs_time.internal.core._EQ_.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p2__41025_SHARP_,x], 0)))){
return p1__41026_SHARP_;
} else {
return null;
}
}),coll));
...
var args__5775__auto__ = [];
var len__5769__auto___41073 = arguments.length;
var i__5770__auto___41074 = (0);
while(true){
if((i__5770__auto___41074 < len__5769__auto___41073)){
...
/** @this {Function} */
(cljs_time.internal.core.format.cljs$lang$applyTo = (function (seq41033){
var G__41034 = cljs.core.first(seq41033);
var seq41033__$1 = cljs.core.next(seq41033);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41034,seq41033__$1);
}));
