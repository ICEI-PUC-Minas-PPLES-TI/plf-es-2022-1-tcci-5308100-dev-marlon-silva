...
var len__5769__auto___23843 = arguments.length;
var i__5770__auto___23844 = (0);
while(true){
if((i__5770__auto___23844 < len__5769__auto___23843)){
args__5775__auto__.push((arguments[i__5770__auto___23844]));

var G__23845 = (i__5770__auto___23844 + (1));
i__5770__auto___23844 = G__23845;
continue;
} else {
}
break;
...
})(),(function (){var iter__5523__auto__ = (function schema$utils$iter__23811(s__23812){
return (new cljs.core.LazySeq(null,(function (){
var s__23812__$1 = s__23812;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__23812__$1);
if(temp__5804__auto__){
var s__23812__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23812__$2)){
var c__5521__auto__ = cljs.core.chunk_first(s__23812__$2);
var size__5522__auto__ = cljs.core.count(c__5521__auto__);
var b__23814 = cljs.core.chunk_buffer(size__5522__auto__);
if((function (){var i__23813 = (0);
while(true){
if((i__23813 < size__5522__auto__)){
var vec__23815 = cljs.core._nth(c__5521__auto__,i__23813);
...
cljs.core.chunk_append(b__23814,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null));

var G__23854 = (i__23813 + (1));
i__23813 = G__23854;
continue;
} else {
var G__23855 = (i__23813 + (1));
i__23813 = G__23855;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23814),schema$utils$iter__23811(cljs.core.chunk_rest(s__23812__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23814),null);
}
} else {
var vec__23818 = cljs.core.first(s__23812__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23818,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23818,(1),null);
if(cljs.core.truth_(v)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null),schema$utils$iter__23811(cljs.core.rest(s__23812__$2)));
} else {
var G__23860 = cljs.core.rest(s__23812__$2);
s__23812__$1 = G__23860;
continue;
}
}
} else {
...
/** @this {Function} */
(schema.utils.assoc_when.cljs$lang$applyTo = (function (seq23809){
var G__23810 = cljs.core.first(seq23809);
var seq23809__$1 = cljs.core.next(seq23809);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23810,seq23809__$1);
}));
...
/** @this {Function} */
(schema.utils.format_STAR_.cljs$lang$applyTo = (function (seq23821){
var G__23822 = cljs.core.first(seq23821);
var seq23821__$1 = cljs.core.next(seq23821);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23822,seq23821__$1);
}));
...
var vec__23824 = cljs.core.re_matches(/#object\[(.*)\]/,cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([f], 0)));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23824,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23824,(1),null);
...
(schema.utils.ErrorContainer.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k23829,else__5346__auto__){
var self__ = this;
var this__5345__auto____$1 = this;
var G__23833 = k23829;
var G__23833__$1 = (((G__23833 instanceof cljs.core.Keyword))?G__23833.fqn:null);
switch (G__23833__$1) {
case "error":
return self__.error;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k23829,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__23834){
var vec__23835 = p__23834;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23835,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23835,(1),null);
...
(schema.utils.ErrorContainer.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__23828){
var self__ = this;
var G__23828__$1 = this;
return (new cljs.core.RecordIter((0),G__23828__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"error","error",-978969032)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(schema.utils.ErrorContainer.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this23830,other23831){
var self__ = this;
var this23830__$1 = this;
return (((!((other23831 == null)))) && ((((this23830__$1.constructor === other23831.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23830__$1.error,other23831.error)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this23830__$1.__extmap,other23831.__extmap)))))));
}));
...
(schema.utils.ErrorContainer.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k23829){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k23829);

}
}));

(schema.utils.ErrorContainer.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__23828){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__23839 = cljs.core.keyword_identical_QMARK_;
var expr__23840 = k__5352__auto__;
if(cljs.core.truth_((pred__23839.cljs$core$IFn$_invoke$arity$2 ? pred__23839.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"error","error",-978969032),expr__23840) : pred__23839.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__23840)))){
return (new schema.utils.ErrorContainer(G__23828,self__.__meta,self__.__extmap,null));
} else {
return (new schema.utils.ErrorContainer(self__.error,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__23828),null));
}
}));
...
(schema.utils.ErrorContainer.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__23828){
var self__ = this;
var this__5342__auto____$1 = this;
return (new schema.utils.ErrorContainer(self__.error,G__23828,self__.__extmap,self__.__hash));
}));
 ...
 */
schema.utils.map__GT_ErrorContainer = (function schema$utils$map__GT_ErrorContainer(G__23832){
var extmap__5385__auto__ = (function (){var G__23842 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__23832,new cljs.core.Keyword(null,"error","error",-978969032));
if(cljs.core.record_QMARK_(G__23832)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__23842);
} else {
return G__23842;
}
})();
return (new schema.utils.ErrorContainer(new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(G__23832),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
