...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__18441_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__18441_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__18441_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__18442){
var vec__18443 = p__18442;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18443,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18443,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__18446,s,color,element,idx){
var map__18447 = p__18446;
var map__18447__$1 = cljs.core.__destructure_map(map__18447);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18447__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18447__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18447__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__18450 = (function (){var or__5045__auto__ = color;
...
var fexpr__18449 = (function (){var G__18451 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__18451) : style_map.call(null,G__18451));
})();
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__18453){
var vec__18454 = p__18453;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18454,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18454,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18454,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__18458){
var vec__18459 = p__18458;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18459,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18459,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18459,(2),null);
...
var G__18569 = cljs.core.next(ssv);
var G__18570 = (this_ssv == null);
var G__18571 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__18572 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__18569;
doing_nil_QMARK_ = G__18570;
last_elide = G__18571;
out = G__18572;
continue;
}
...
var vec__18465 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18465,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18465,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18465,(2),null);
...
var G__18573 = cljs.core.next(remaining_cvec);
var G__18574 = new_idx;
var G__18575 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__18573;
idx = G__18574;
out = G__18575;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__18477,cursor_vec){
var vec__18478 = p__18477;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18478,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18478,(1),null);
var focus_vec = vec__18478;
...
var vec__18481 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18481,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18481,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__18484){
var vec__18485 = p__18484;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18485,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18485,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__18501,existing_count){
var vec__18502 = p__18501;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18502,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18502,(1),null);
...
return cljs.core.filterv((function (p1__18498_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__18498_SHARP_))));
...
var vec__18541 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18541,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18541,(1),null);
var cvec_element = vec__18541;
if((cvec_element == null)){
var G__18589 = cljs.core.next(cvec_nl);
var G__18590 = (idx + (1));
var G__18591 = start;
var G__18592 = out;
cvec_nl = G__18589;
...
var G__18593 = cljs.core.next(cvec_nl);
var G__18594 = (idx + (1));
var G__18595 = idx;
var G__18596 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__18593;
idx = G__18594;
start = G__18595;
out = G__18596;
...
var G__18597 = cljs.core.next(cvec_nl);
var G__18598 = (idx + (1));
var G__18599 = (idx + (1));
var G__18600 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__18597;
idx = G__18598;
start = G__18599;
out = G__18600;
...
var G__18601 = cljs.core.next(cvec_nl);
var G__18602 = (idx + (1));
var G__18603 = idx;
var G__18604 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__18601;
idx = G__18602;
start = G__18603;
out = G__18604;
...
var G__18605 = cljs.core.next(cvec_nl);
var G__18606 = (idx + (1));
var G__18607 = start;
var G__18608 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__18605;
idx = G__18606;
start = G__18607;
out = G__18608;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__18545_SHARP_,p2__18544_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__18544_SHARP_)){
return cljs.core.reduced(p1__18545_SHARP_);
} else {
return (p1__18545_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__18548,p__18549){
var vec__18550 = p__18548;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18550,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18550,(1),null);
var vec__18553 = p__18549;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18553,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18553,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__18561,cvec,focus_vec){
var map__18562 = p__18561;
var map__18562__$1 = cljs.core.__destructure_map(map__18562);
var options = map__18562__$1;
var map__18563 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18562__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__18563__$1 = cljs.core.__destructure_map(map__18563);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18563__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18563__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18563__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18560_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__18560_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
