...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__40710 = c;
var G__40710__$1 = (((G__40710 == null))?null:G__40710.prototype);
if((G__40710__$1 == null)){
return null;
} else {
return G__40710__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__40713 = c;
var G__40713__$1 = (((G__40713 == null))?null:G__40713.prototype);
if((G__40713__$1 == null)){
return null;
} else {
return G__40713__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__40721 = c;
var G__40721__$1 = (((G__40721 == null))?null:G__40721.constructor);
if((G__40721__$1 == null)){
return null;
} else {
return G__40721__$1.displayName;
}
})();
...
var G__40722 = c;
var G__40722__$1 = (((G__40722 == null))?null:G__40722.constructor);
if((G__40722__$1 == null)){
return null;
} else {
return G__40722__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__40724 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__40725 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__40725);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__40724);
}});
...
var G__40728 = key;
var G__40728__$1 = (((G__40728 instanceof cljs.core.Keyword))?G__40728.fqn:null);
switch (G__40728__$1) {
...
var c = this;
var G__40763_40815 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__40763_40815 == null)){
} else {
re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__40763_40815);
}
...
var renders_40816 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_40817 = cljs.core.first(cljs.core.vals(renders_40816));
...
if((cljs.core.count(renders_40816) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_40816))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_40817)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_40817], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__40798 = o;
re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.set(G__40798,cljs.core.name(k),v);
...
return (function() { 
var G__40820__delegate = function (args){
return re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__40821__i < G__40821__a.length) {G__40821__a[G__40821__i] = arguments[G__40821__i + 0]; ++G__40821__i;}
  args = new cljs.core.IndexedSeq(G__40821__a,0,null);
} 
return G__40820__delegate.call(this,args);};
G__40820.cljs$lang$maxFixedArity = 0;
G__40820.cljs$lang$applyTo = (function (arglist__40822){
var args = cljs.core.seq(arglist__40822);
return G__40820__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__40799 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__40800 = c;
(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__40800);
...
}finally {(re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__40799);
}});
...
var vec__40801 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40801,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40801,(1),null);
...
var G__40804 = re_frisk.inlined_deps.reagent.v1v0v0.reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__40804 == null)){
return null;
} else {
return re_frisk.inlined_deps.reagent.v1v0v0.reagent.ratom.dispose_BANG_(G__40804);
}
});
}),[]);
