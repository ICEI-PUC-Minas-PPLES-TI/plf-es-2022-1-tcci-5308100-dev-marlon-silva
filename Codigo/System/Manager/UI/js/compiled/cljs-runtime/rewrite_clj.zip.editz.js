...
return rewrite_clj.node.protocols.coerce((function (){var G__21247 = rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(node,opts);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__21247) : f.call(null,G__21247));
})());
});
});
/**
...
var len__5769__auto___21275 = arguments.length;
var i__5770__auto___21276 = (0);
while(true){
if((i__5770__auto___21276 < len__5769__auto___21275)){
args__5775__auto__.push((arguments[i__5770__auto___21276]));

var G__21277 = (i__5770__auto___21276 + (1));
i__5770__auto___21276 = G__21277;
continue;
} else {
}
break;
...
return rewrite_clj.custom_zipper.core.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.node_editor(rewrite_clj.zip.options.get_opts(zloc)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__21248_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__21248_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq21249){
var G__21250 = cljs.core.first(seq21249);
var seq21249__$1 = cljs.core.next(seq21249);
var G__21251 = cljs.core.first(seq21249__$1);
var seq21249__$2 = cljs.core.next(seq21249__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21250,G__21251,seq21249__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__21258 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__21258) : str_fn.call(null,G__21258));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__21259 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__21259) : str_fn.call(null,G__21259));
})()):null)));
...
var G__21264 = rewrite_clj.zip.base.tag(zloc);
var G__21264__$1 = (((G__21264 instanceof cljs.core.Keyword))?G__21264.fqn:null);
switch (G__21264__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__21261_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21261_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__21262_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21262_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21264__$1)].join('')));
...
var G__21272 = rewrite_clj.zip.base.tag(zloc);
var G__21272__$1 = (((G__21272 instanceof cljs.core.Keyword))?G__21272.fqn:null);
switch (G__21272__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__21270_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21270_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
