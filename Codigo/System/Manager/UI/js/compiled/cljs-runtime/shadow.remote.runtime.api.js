...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26072 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26072(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_26073 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_26073(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_26074 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_26074(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_26076 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_26076(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26080 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26080(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26083 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26083(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__26060,callback){
var map__26061 = p__26060;
var map__26061__$1 = cljs.core.__destructure_map(map__26061);
var input = map__26061__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26061__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26061__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
