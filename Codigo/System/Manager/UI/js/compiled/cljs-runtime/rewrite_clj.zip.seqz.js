...
var G__21285 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null,zloc_n0));
var G__21285__$1 = (((G__21285 == null))?null:cljs.core.iterate((function (loc){
...
var G__21285__$2 = (((G__21285__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__21285__$1));
var G__21285__$3 = (((G__21285__$2 == null))?null:cljs.core.last(G__21285__$2));
if((G__21285__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__21285__$3);
}
} else {
return zloc;
}
...
var G__21304 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__21305 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__21304;
parent = G__21305;
continue;
} else {
var G__21306 = rewrite_clj.zip.move.right(zloc_map_value);
var G__21307 = parent;
loc = G__21306;
parent = G__21307;
continue;
...
var G__21310 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__21311 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__21310;
parent = G__21311;
continue;
} else {
var G__21312 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__21313 = parent;
loc = G__21312;
parent = G__21313;
continue;
...
var G__21299 = zloc;
var G__21299__$1 = (((G__21299 == null))?null:rewrite_clj.zip.move.down(G__21299));
var G__21299__$2 = (((G__21299__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__21299__$1,k));
if((G__21299__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__21299__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__21300 = zloc;
var G__21300__$1 = (((G__21300 == null))?null:rewrite_clj.zip.move.down(G__21300));
var G__21300__$2 = (((G__21300__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__21300__$1));
var G__21300__$3 = (((G__21300__$2 == null))?null:rewrite_clj.zip.move.down(G__21300__$2));
var G__21300__$4 = (((G__21300__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__21300__$3,k));
if((G__21300__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__21300__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__21301 = rewrite_clj.zip.move.down(zloc);
var G__21301__$1 = (((G__21301 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__21301));
if((G__21301__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__21301__$1);
}
})(),k);
