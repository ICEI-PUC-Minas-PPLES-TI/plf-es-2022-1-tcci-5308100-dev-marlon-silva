...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5345__auto__,k19468,else__5346__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k19468,else__5346__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5366__auto__,p__19493){
var vec__19494 = p__19493;
var k__5367__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19494,(0),null);
var v__5368__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19494,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__19467){
var self__ = this;
var G__19467__$1 = this;
return (new cljs.core.RecordIter((0),G__19467__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this19469,other19470){
var self__ = this;
var this19469__$1 = this;
return (((!((other19470 == null)))) && ((((this19469__$1.constructor === other19470.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19469__$1.tag,other19470.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19469__$1.format_string,other19470.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19469__$1.wrap_length,other19470.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19469__$1.seq_fn,other19470.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19469__$1.children,other19470.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this19469__$1.__extmap,other19470.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__19517 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__19517) : self__.seq_fn.call(null,G__19517));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5350__auto__,k19468){
var self__ = this;
var this__5350__auto____$1 = this;
var G__19530 = k19468;
var G__19530__$1 = (((G__19530 instanceof cljs.core.Keyword))?G__19530.fqn:null);
switch (G__19530__$1) {
case "tag":
case "format-string":
case "wrap-length":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k19468);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5351__auto__,k__5352__auto__,G__19467){
var self__ = this;
var this__5351__auto____$1 = this;
var pred__19534 = cljs.core.keyword_identical_QMARK_;
var expr__19535 = k__5352__auto__;
if(cljs.core.truth_((pred__19534.cljs$core$IFn$_invoke$arity$2 ? pred__19534.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__19535) : pred__19534.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__19535)))){
return (new rewrite_clj.node.seq.SeqNode(G__19467,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__19534.cljs$core$IFn$_invoke$arity$2 ? pred__19534.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__19535) : pred__19534.call(null,new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__19535)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__19467,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__19534.cljs$core$IFn$_invoke$arity$2 ? pred__19534.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__19535) : pred__19534.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__19535)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__19467,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__19534.cljs$core$IFn$_invoke$arity$2 ? pred__19534.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__19535) : pred__19534.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__19535)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__19467,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__19534.cljs$core$IFn$_invoke$arity$2 ? pred__19534.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__19535) : pred__19534.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__19535)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__19467,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5352__auto__,G__19467),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5342__auto__,G__19467){
var self__ = this;
var this__5342__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__19467,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__19471){
var extmap__5385__auto__ = (function (){var G__19556 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__19471,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__19471)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__19556);
} else {
return G__19556;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__19471),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__19471),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__19471),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__19471),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__19471),null,cljs.core.not_empty(extmap__5385__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),(function (p1__19560_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__19560_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),(function (p1__19564_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__19564_SHARP_);
}),children);
});
