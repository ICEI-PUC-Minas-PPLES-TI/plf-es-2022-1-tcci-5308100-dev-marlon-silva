...
var G__38252 = sci.core.new_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__38252);
...
var G__38258 = sci.core.new_dynamic_var.cljs$core$IFn$_invoke$arity$3(name,null,null);
sci.impl.vars.unbind(G__38258);
...
var len__5769__auto___38328 = arguments.length;
var i__5770__auto___38329 = (0);
while(true){
if((i__5770__auto___38329 < len__5769__auto___38328)){
args__5775__auto__.push((arguments[i__5770__auto___38329]));

var G__38330 = (i__5770__auto___38329 + (1));
i__5770__auto___38329 = G__38330;
continue;
} else {
}
break;
...
/** @this {Function} */
(sci.core.alter_var_root.cljs$lang$applyTo = (function (seq38283){
var G__38284 = cljs.core.first(seq38283);
var seq38283__$1 = cljs.core.next(seq38283);
var G__38285 = cljs.core.first(seq38283__$1);
var seq38283__$2 = cljs.core.next(seq38283__$1);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38284,G__38285,seq38283__$2);
}));
...
var G__38306 = ex;
var G__38306__$1 = (((G__38306 == null))?null:cljs.core.ex_data(G__38306));
var G__38306__$2 = (((G__38306__$1 == null))?null:new cljs.core.Keyword("sci.impl","callstack","sci.impl/callstack",-1621010557).cljs$core$IFn$_invoke$arity$1(G__38306__$1));
if((G__38306__$2 == null)){
return null;
} else {
return sci.impl.callstack.stacktrace(G__38306__$2);
}
});
/**
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__38311){
var vec__38312 = p__38311;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38312,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38312,(1),null);
...
sci.core.process_publics = (function sci$core$process_publics(publics,p__38315){
var map__38316 = p__38315;
var map__38316__$1 = cljs.core.__destructure_map(map__38316);
var exclude = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38316__$1,new cljs.core.Keyword(null,"exclude","exclude",-1230250334));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ns_map,p__38317){
var vec__38318 = p__38317;
var var_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38318,(0),null);
var var$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38318,(1),null);
...
return cljs.core.select_keys(p1__38321_SHARP_,opts);
});
} else {
return (function (p1__38322_SHARP_){
return cljs.core.select_keys(p1__38322_SHARP_,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"arglists","arglists",1661989754),new cljs.core.Keyword(null,"no-doc","no-doc",1559921891),new cljs.core.Keyword(null,"macro","macro",-867863404),new cljs.core.Keyword(null,"doc","doc",1913296891)], null));
});
