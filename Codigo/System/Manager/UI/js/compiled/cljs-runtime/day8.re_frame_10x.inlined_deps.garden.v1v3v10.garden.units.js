 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__14987,right){
var map__14988 = p__14987;
var map__14988__$1 = cljs.core.__destructure_map(map__14988);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14988__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14988__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__14994 = temp__5804__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14994,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14994,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14994,(2),null);
...
var map__15003 = u(x);
var map__15003__$1 = cljs.core.__destructure_map(map__15003);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15003__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__15004 = u(y);
var map__15004__$1 = cljs.core.__destructure_map(map__15004);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15004__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3 = (function() { 
var G__15086__delegate = function (x,y,more){
...
var G__15087__i = 0, G__15087__a = new Array(arguments.length -  2);
while (G__15087__i < G__15087__a.length) {G__15087__a[G__15087__i] = arguments[G__15087__i + 2]; ++G__15087__i;}
  more = new cljs.core.IndexedSeq(G__15087__a,0,null);
} 
...
var G__15089 = null;
if (arguments.length > 2) {
var G__15090__i = 0, G__15090__a = new Array(arguments.length -  2);
while (G__15090__i < G__15090__a.length) {G__15090__a[G__15090__i] = arguments[G__15090__i + 2]; ++G__15090__i;}
G__15089 = new cljs.core.IndexedSeq(G__15090__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__15089);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15013__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__15015 = u(y);
var map__15015__$1 = cljs.core.__destructure_map(map__15015);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15015__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__15091__delegate = function (x,y,more){
...
var more = null;
if (arguments.length > 2) {
var G__15092__i = 0, G__15092__a = new Array(arguments.length -  2);
while (G__15092__i < G__15092__a.length) {G__15092__a[G__15092__i] = arguments[G__15092__i + 2]; ++G__15092__i;}
  more = new cljs.core.IndexedSeq(G__15092__a,0,null);
} 
...
var more = cljs.core.rest(arglist__15093);
...
var G__15094 = null;
if (arguments.length > 2) {
var G__15095__i = 0, G__15095__a = new Array(arguments.length -  2);
while (G__15095__i < G__15095__a.length) {G__15095__a[G__15095__i] = arguments[G__15095__i + 2]; ++G__15095__i;}
G__15094 = new cljs.core.IndexedSeq(G__15095__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__15094);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15022__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__15023 = u(y);
var map__15023__$1 = cljs.core.__destructure_map(map__15023);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15023__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__15100__delegate = function (x,y,more){
...
var G__15100 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__15101__i = 0, G__15101__a = new Array(arguments.length -  2);
while (G__15101__i < G__15101__a.length) {G__15101__a[G__15101__i] = arguments[G__15101__i + 2]; ++G__15101__i;}
  more = new cljs.core.IndexedSeq(G__15101__a,0,null);
} 
return G__15100__delegate.call(this,x,y,more);};
...
return G__15100__delegate(x,y,more);
});
...
var G__15104 = null;
if (arguments.length > 2) {
var G__15105__i = 0, G__15105__a = new Array(arguments.length -  2);
while (G__15105__i < G__15105__a.length) {G__15105__a[G__15105__i] = arguments[G__15105__i + 2]; ++G__15105__i;}
G__15104 = new cljs.core.IndexedSeq(G__15105__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__15104);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__15032 = u(x);
var map__15032__$1 = cljs.core.__destructure_map(map__15032);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15032__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__15033 = u(y);
var map__15033__$1 = cljs.core.__destructure_map(map__15033);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15033__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
...
var more = null;
if (arguments.length > 2) {
var G__15110__i = 0, G__15110__a = new Array(arguments.length -  2);
while (G__15110__i < G__15110__a.length) {G__15110__a[G__15110__i] = arguments[G__15110__i + 2]; ++G__15110__i;}
  more = new cljs.core.IndexedSeq(G__15110__a,0,null);
} 
...
var G__15112 = null;
if (arguments.length > 2) {
var G__15113__i = 0, G__15113__a = new Array(arguments.length -  2);
while (G__15113__i < G__15113__a.length) {G__15113__a[G__15113__i] = arguments[G__15113__i + 2]; ++G__15113__i;}
G__15112 = new cljs.core.IndexedSeq(G__15113__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__15112);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
