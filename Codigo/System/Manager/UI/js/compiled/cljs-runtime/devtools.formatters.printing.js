...
var len__5769__auto___9434 = arguments.length;
var i__5770__auto___9435 = (0);
while(true){
if((i__5770__auto___9435 < len__5769__auto___9434)){
args__5775__auto__.push((arguments[i__5770__auto___9435]));

var G__9436 = (i__5770__auto___9435 + (1));
i__5770__auto___9435 = G__9436;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9297){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9298,G__9299,seq9297__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9382_SHARP_){
return (!((cljs.core.meta(p1__9382_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9383__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9384){var _e__8471__auto__ = e9384;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e9386){var _e__8471__auto__ = e9386;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9391 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9392 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9392);
...
var map__9393 = opts;
var map__9393__$1 = cljs.core.__destructure_map(map__9393);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__9393__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9391);
}});
...
var temp__5802__auto___9449 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___9449)){
var managed_print_level_9450 = temp__5802__auto___9449;
var _STAR_print_level_STAR__orig_val__9407_9451 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9408_9452 = managed_print_level_9450;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9408_9452);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__9398_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__9398_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9407_9451);
}} else {
job_fn();
}
