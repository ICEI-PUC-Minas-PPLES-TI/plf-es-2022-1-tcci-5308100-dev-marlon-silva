...
var G__9239 = devtools.prefs.pref(v);
v = G__9239;
continue;
} else {
return v;
...
}catch (e9132){var _e__8471__auto__ = e9132;
return false;
}})();
...
}catch (e9138){var _e__8471__auto__ = e9138;
return false;
}})();
...
}catch (e9142){var _e__8471__auto__ = e9142;
return false;
}}
}
});
...
var vec__9155 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9155,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9155,(1),null);
...
return cljs.core.some((function (p1__9186_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9186_SHARP_);
}),template);
});
