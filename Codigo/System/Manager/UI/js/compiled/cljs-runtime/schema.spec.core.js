...
var schema$spec$core$CoreSpec$subschemas$dyn_24152 = (function (this$){
...
return schema$spec$core$CoreSpec$subschemas$dyn_24152(this$);
}
});

var schema$spec$core$CoreSpec$checker$dyn_24157 = (function (this$,params){
var x__5393__auto__ = (((this$ == null))?null:this$);
...
return schema$spec$core$CoreSpec$checker$dyn_24157(this$,params);
}
});
...
var G__24139 = schema.utils.value_name(x);
return (err_f.cljs$core$IFn$_invoke$arity$1 ? err_f.cljs$core$IFn$_invoke$arity$1(G__24139) : err_f.call(null,G__24139));
}),null)),reason));
} else {
return null;
}
...
var G__24145 = (new cljs.core.Delay((function (){
var fexpr__24146 = cljs.core.deref(cache);
return (fexpr__24146.cljs$core$IFn$_invoke$arity$1 ? fexpr__24146.cljs$core$IFn$_invoke$arity$1(cache_key) : fexpr__24146.call(null,cache_key));
}),null));
return (wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1 ? wrap_recursive_delay.cljs$core$IFn$_invoke$arity$1(G__24145) : wrap_recursive_delay.call(null,G__24145));
} else {
return w;
}
} else {
 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__24147,p__24148){
var map__24149 = p__24147;
var map__24149__$1 = cljs.core.__destructure_map(map__24149);
var schema__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24149__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24149__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
var map__24150 = p__24148;
var map__24150__$1 = cljs.core.__destructure_map(map__24150);
var params = map__24150__$1;
var subschema_checker = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24150__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24150__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
var sub = schema.spec.core.with_cache(cache,schema__$1,(function (d){
return (function (x){
var fexpr__24151 = cljs.core.deref(d);
return (fexpr__24151.cljs$core$IFn$_invoke$arity$1 ? fexpr__24151.cljs$core$IFn$_invoke$arity$1(x) : fexpr__24151.call(null,x));
});
}),(function (){
