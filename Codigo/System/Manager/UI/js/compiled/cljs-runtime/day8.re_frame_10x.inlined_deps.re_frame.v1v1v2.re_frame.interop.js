...
return [(function (){var pred__12373 = cljs.core.instance_QMARK_;
var expr__12374 = reactive_val;
if(cljs.core.truth_((pred__12373.cljs$core$IFn$_invoke$arity$2 ? pred__12373.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__12374) : pred__12373.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__12374)))){
return "ra";
} else {
if(cljs.core.truth_((pred__12373.cljs$core$IFn$_invoke$arity$2 ? pred__12373.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__12374) : pred__12373.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__12374)))){
return "rc";
} else {
if(cljs.core.truth_((pred__12373.cljs$core$IFn$_invoke$arity$2 ? pred__12373.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__12374) : pred__12373.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__12374)))){
return "rx";
} else {
if(cljs.core.truth_((pred__12373.cljs$core$IFn$_invoke$arity$2 ? pred__12373.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__12374) : pred__12373.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__12374)))){
return "tr";
} else {
return "other";
}
